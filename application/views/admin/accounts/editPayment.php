<div class="side_right">
    ...
    <div class="page-header">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 ">
          <ul class="btn_ul" style="float:right;">
            <li> <a href="<?php echo base_url();?>index.php/accounts/viewPayment" class="btn btn-primary">View&nbsp;&nbsp;<i class="fa fa-eye" aria-hidden="true"></i></a> </li>
          </ul>
        </div>
    </div>
       <div class="row">
	     <div class="col-lg-12 col-md-12 col-sm-12 ">
		  <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
			<div class="row">
              <div class="col-lg-6 col-md-6 col-sm-6 ">
                <h2 class="page_txt"><i class="fa fa-list-ol" aria-hidden="true"></i>&nbsp;&nbsp;Edit Payment </h2>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-6 ">
        <div class="header">
  <div class="header-right">
 	<h5>Last Vocher No: <?= $voucher_no; ?></h5>
		       ...
		       <form action="<?php echo base_url(); ?>index.php/accounts/editPayment/<?php echo $id; ?>" method="post" onsubmit="return validateForm()" id="myform">
            	...
            	<table class="table table-responsive-sm">
            		<thead style="background-color:gray;">
                        ...
                        <th style="width: 20%;">Vou #</th>
                			...
                			<th colspan="5" style="width: 5%;text-align:right;"></th>
            			</tr>
            		</thead>
            		<tbody id="dataTable2">
                		<tr>
                        <td><input type="text" name="voucher_no[]" id="vou_100" class="sq_form" placeholder="Voucher No" value="<?php echo $receipt->voucher_no; ?>" required></td>
                        <td><input type="hidden" value="100" id="row_value">
                        <select name="led_Id[]" id="star_100" class="sq_form" required>
                                	<option value="">Select Ledger</option>
                    			<?php foreach($ledger as $val){ ?>  
                    				<option value="<?= $val['led_Id']; ?>" <?php if($val['led_Id']==$receipt->ledger) { echo "selected"; } ?>><?= $val['name']; ?></option>
                    			<?php } ?>
                    			</select>
                			</td>
                      <td><input type="text" name="amount[]" id="amount_100" class="sq_form" placeholder="Amount" value="<?php echo $receipt->amount; ?>" required></td>
                      <td><select name="mode[]" id="mode_100" class="sq_form" required>
                            <option value="">Select Mode</option>
                            <?php foreach($mode as $val){ ?>
                        <option value="<?= $val['led_Id']; ?>" <?php if($receipt->mode==$val['led_Id']) { echo "selected";} ?>><?= $val['name']; ?></option>
                      <?php } ?>
                    			</select>
                			</td>
                			<td><input type="text" name="narration[]" id="narration_100" class="sq_form" placeholder="Narration" value="<?php echo $receipt->narration; ?>"></td>
                			<td><input type="date" name="date1[]" id="date_100" class="sq_form" placeholder="Date" value="<?php echo $receipt->payment_date; ?>" onkeypress="return myKeyPress(event)"></td>
                			<td></td>
                		</tr>
                	</tbody>
            	</table>			
