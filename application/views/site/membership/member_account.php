...
<body>
    <div class="foam-padding">
        ...
        <div class="card">
		<?php  if($message!='') { echo '<div class="alert alert-danger">'.$message."</div><br/>"; } ?>
            <form action="<?php echo base_url(); ?>index.php/membership/otpForm" method="post">
				...
				<br/>
				<a href="<?php echo base_url(); ?>index.php/membership">
				 <button type="button">New User ? Login Here</button>
				</a>
			</form>
        </div>
    </div>
