		   ...
		   <div class="col-lg-12">
            ...
            <div class="form-group" style="margin-top: 7px;" id="paymenttable">
                  ...
                  <option value="">Select Type *</option>
                        ...
                        <option value="0" <?php if($bill_list[0]['mode']=="0"){ echo "selected";}?>>Online </option>
                      <option value="7" <?php if($bill_list[0]['mode']=="7"){ echo "selected";}?>>Card</option>
                  		  <option value="8" <?php if($bill_list[0]['mode']=="8"){ echo "selected";}?>>MO</option>
                  </select>
               </div>
            </div>
            <div class="col-md-12">
