...
<!--                                 	    <tr>
                                    ...
                                    if(@$discount!='') { ?>
                                        <tr>
                                            <th></th>
                                            <th colspan="5" style="text-align:right">Membership Privilege</th>
                                            <th style="text-align:right" id="total"><?php
											if(@$discountype=='Fixed') { 
											echo $total1=@$discount;
											}
											else
											{
                                        ...
                                        <tr>
                                            ...
                                            <th style="text-align:right" id="total"><?php echo $total-@$total1;?></th>
                                        </tr>
                                        <tr>
                      ...
                      <div class="mybooking cart">
                        ...
                        <?php }?>
                         ...
                         <div class="col-lg-12 cssmobile" align="center" style="display: none;">
                            <a href="<?php echo base_url(); ?>index.php/worldline/booking"><input type="button" value="Back" class="btn btn-warning cart_btn"></a>
...
<script>
	function deletebook(obj){
    	...
    	var url = (is_donation == 1) ? 
        				'<?php echo base_url();?>index.php/worldline/discardDonation/'+id
        				: '<?php echo base_url();?>index.php/worldline/discard/'+id
...
$('#search_devotee').on('click', () => {
		$.ajax({
                url: '<?php echo base_url();?>index.php/worldline/search_devotee',
                type: 'post',
                dataType: "json",
                data:{
                    search: $('#mobile').val()
