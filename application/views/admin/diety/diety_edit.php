       ...
       <div class="row">
	     <div class="col-lg-12 col-md-12 col-sm-12 ">		 
	        <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
               <div class="row">
                  <div class="col-lg-12 col-md-12 col-sm-12 ">
                    <h2 class="page_txt"><i class="fa fa-pencil" aria-hidden="true"></i>&nbsp;&nbsp;Edit Diety </h2>
                  </div>
			   </div>
				<?php foreach($diety_list as $val){ ?>
		       <form action="<?php echo base_url(); ?>index.php/admin/admin/edit_diety/<?php echo $val['id']; ?>" method="post" >
      <div class="form_body">
        <div class="row">
        	<div class="col-lg-6">
        ...
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder=" Name in Malayalam" id="name_mal" name="name_mal"  value="<?php echo $val['name_mal']; ?>" type="text" >
        ...
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder="Order" id="order" name="order" value="<?php echo $val['order_']; ?>" type="text">
    ...
    <?php endif; ?>	
        ...
        <div class="form-group pt-2">
          <div class="form-check mt-5">
  			<input class="form-check-input" type="checkbox" name="online" value="1" id="flexCheckDefault" style="transform: scale(1.5);" <?php if($val['online'] == 1) echo 'checked'; ?>>
