    ...
    <div class="page-header">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 ">
          <ul class="btn_ul" style="float:right;">
            <li> <a href="<?php echo base_url();?>index.php/accounts/addcontra" class="btn btn-primary">Add New&nbsp;&nbsp;<i class="fa fa-plus" aria-hidden="true"></i></a> </li>
          </ul>
        </div>
    </div>
       <div class="row">
	     <div class="col-lg-12 col-md-12 col-sm-12 ">
		  <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
			<div class="row">
              <div class="col-lg-6 col-md-6 col-sm-6 ">
                <h2 class="page_txt"><i class="fa fa-list-ol" aria-hidden="true"></i>&nbsp;&nbsp;View Contra </h2>
              </div>
			 </div>	
...
<!-- 						  <a href="<?php echo base_url(); ?>index.php/accounts/printjournal/<?= $val['pay_Id']; ?>" class="btn btn-outline-info" style="padding:6px;" title="Print"> <i class="fa fa-print"></i></a> 
                          &nbsp;&nbsp;&nbsp;&nbsp; -->
						   <?php if ($role=="superadmin" || $role=="admin"){?>  <a href="<?php echo base_url(); ?>index.php/accounts/deletejournal/<?= $val['pay_Id']; ?>"  onclick="return confirm('Are you sure you want to delete?')"
