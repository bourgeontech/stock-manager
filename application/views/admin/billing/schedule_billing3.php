    ...
    <div class="row">
	   <div class="col-lg-12 col-md-12 col-sm-12 ">		 
	      <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
	        <form id="myform" action="<?php echo base_url(); ?>index.php/admin/admin/schedule" method="post">
               <div class="row">
...
<!--                                 <th style="text-align:right;"><span onclick="addRow()"><i class="fa fa-plus" style="padding: 8px;"></i></span></th> -->
                            ...
                            <tr>
                               <td>
                                   <input type="text" name="search_pooja" class="sq_form" id="searchpooja" placeholder="Search Pooja By Code/Name"  autocomplete="off" />
                                    <input type="hidden" name="pooja_id" id="pooja_100" />
<!--                                   <select name="pooja_id" id="pooja_100" onchange="change_rate(100)"  onload="change_rate(100)" class="js-example-basic-single sq_form" style="width: 3.2cm;">
                                    <option value="0">Please Select</option>
                                </select> -->
                            </td>  <td><select name="diety_id" id="diety_id"  class="sq_form" style="width:100%;">
                                    <option selected="selected" value="0">Please Select</option>
                                        <?php foreach ($diety_list as $diety){  ?>
                                        <option value="<?php echo $diety['id'];?>"><?php echo $diety['name'];?></option>
                                        <?php  } ?>
                                </select></td>
                                <td><input type="text" name="ben_name" id="name_100" class="sq_form name" placeholder="Name" value="" required style="width: 3.2cm;" ></td>
                                <td><!--<select name="star_id" id="star_100" class=" sq_form firststar" required style="width: 3.2cm;">
                                    <option value="">Select Star</option>
                                    <?php foreach($star_list as $val){ ?>  
                                      //  <option data-name="<?= $val['name_eng']; ?>" value="<?= $val['id']; ?>"><?= $val['name_eng']." - ".$val['name_mal']; ?></option>
                                    <?php } ?>
                                </select>-->
                           <!--  <input type="text" name="star_search" class="sq_form" id="star_search" placeholder="Search Star"  autocomplete="off"/>
                                 <input type="hidden" name="star_id" class="sq_form" id="star_id" />-->
                                <select name="star_id" id="star_100" class=" sq_form firststar" required style="width: 3.2cm;">
                                    <option value="">Select Star</option>
                                    <?php foreach($star_list as $val){ ?>  
                                        <option data-name="<?= $val['name_eng']; ?>" value="<?= $val['id']; ?>"><?= $val['name_eng']." - ".$val['name_mal']; ?></option>
                                    <?php } ?>
                                ...
                                <td><input type="hidden" value="100" id="row_value">
                                    <input id="qlt_100" type="number" min="1" name="qlt" onchange="checkallowedqty(100);calcPoojaVal();" onkeyup="checkallowedqty(100);calcPoojaVal();"  class="sq_form" placeholder="Quatity" value="1"></td>
                                <td><input id="rate_100" type="text" name="rate"  class="sq_form"  placeholder="Rate" readonly value="" tabindex="-1"></td>
                                <td><input id="amt_100" type="text" name="amt"  class="sq_form" onkeyup="totalgross()" placeholder="Amount" tabindex="-1" readonly value=""></td>
...
<!--                                                      <input type="text" name="star[]" id="month"  class="sq_form  monthstar" /> -->
                                                </td>
                                                ...
                                                <td class="star">
                                                  <select name="star[]" id="month"  class=" sq_form  monthstar select2" multiple >
                                                        <option value="">Select Star</option>
                                                    <?php foreach($star_list as $val){ ?>  
                                                ...
                                                <td><input name="main_date" type="date" class="form-control clickable input-md date_inp" id="datefrom"  value="<?php echo date('Y-m-d');?>" placeholder="&#xf133; Date" ></td>
...
<!--                                                 <input type="date"  class="form-control clickable input-md date_inp" id="dateto" min="<?php echo date('Y-m-d');?>"
                                                ...
                                                <td class="dateto"><input id="cdt" type="text" class="form-control" value="" readonly /> </td>
...
<!--                                     <table>
                                    ...
                                    <table class="table  srp_table" id="paymenttable" width="100%">
                                        <thead>
                                            <tr>
                                                <th>Payment Type</th>
                                                <th>Bill Amount</th>
                          ...
                          <option value="5">NEFT</option>
                  		  ...
                  		  <option value="8">MO</option>
                                           ...
                                           <td><input id="bill_amount" type="text" name="bill_amount" class="sq_form"  placeholder=""  value="" readonly  tabindex="-1"></td>
                                           <td class="cashdetails"><input id="amount_received" type="text" name="amount_received" onkeyup="checkBal()" class="sq_form"  placeholder=""  value="" tabindex="-1"></td>
                                           <td class="cashdetails"><input id="balance" type="text" name="balance" class="sq_form"  placeholder=""  value="" tabindex="-1"></td>
                                        </tr>
        ...
        <!-- <div style="align: center;" class="form_body">
          ...
          <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative">
               ...
               <tr>
                                                ...
                                                <th>Post Office</th>
                                           <tr>
                                           <td><input style="border-color: red;" type="text" name="mobile" id="mobile" list="mobiles" onchange="change_mob()" class="sq_form" placeholder="" required  value="">
                                           <datalist id="mobiles">
                                           ...
                                           <td><input style="border-color: red;" type="text" id="dname" name="name" class="sq_form" placeholder="" required  value=""></td>
                                           <td><input type="text" name="house_name" id="house_name" class="sq_form" placeholder=""  value="" tabindex="-1"></td>
                                           <td><input type="text" name="post" id="post" class="sq_form" placeholder=""  value=""  tabindex="-1"></td>
                                        </tr>
                                        <tr>
                                                <th>Place</th>
                                                <th>Pincode</th>
                                         ...
                                         <tr>
                                           <td><input type="text" name="street" id="street" class="sq_form" placeholder=""  value=""  tabindex="-1"></td>
                                           <td><input type="text" name="pincode" id="pincode" class="sq_form" placeholder=""  value=""  tabindex="-1"></td>
                                           <td><input type="text" name="district" id="district" class="sq_form" placeholder=""  value=""  tabindex="-1"></td>
                                           <td><input type="text" name="email" id="email" class="sq_form" placeholder=""  value=""  tabindex="-1"></td>
                                        </tr>
                                    </table>
                                 </div>  
               <div class="col-sm-12 buttons" style="display:none;">
                      <!--  <button id="save" type="submit" class="btn btn-success" name="save" value="save" style="margin:-10px 4px 0 4px;"> Save </button>!-->
                        <button id="saveandprint" type="submit" class="btn " name="save" value="saveandprint" style="margin:-10px 4px 0 4px;background-color:#90EE90;" onfocus="test();"> Save & Print</button>
          </div>
          </div>
	    </div>
...
<script>
       	 window.onload = (event) => {
             var inp  = $("input#searchpooja.sq_form ui-autocomplete-input").focus().select();
         console.log(inp);
       ...
       //document.getElementById('searchpooja').select();
         $( "#name_100" ).keyup(function() {
             $('#dname').val($(this).val());
         });
    ...
    $( "#star_search" ).autocomplete({
      source: function(request, response) {
        ...
        function change_mob(){
            $.ajax({
                   url:"<?php echo base_url(); ?>index.php/admin/admin/getCustomerByPhone",
                   type: 'post',
                   dataType: "json",
                   data:{ 
                      phone:$('#mobile').val(),
         ...
         function searchPooja(){
              $.ajax({
                   ...
                   success: function( data ) {
                         $('#rate_100').val(data.rate);
                         $('#pooja_100').val(data.pooja_id);
                         $("#searchpooja" ).val(data.pooja);
                         $('#diety_id').val(data.diety);
                         calcPoojaVal();
                   },
...
//          });
   ...
   $( "#qlt_100" ).keyup(function() {
        calcPoojaVal();
   });
   function calcPoojaVal(){
       var qty = $('#qlt_100').val();
       var rate = $('#rate_100').val();
       var subt = qty * rate;
       $('#amt_100').val(subt);
   }
...
function test()
    {
    $('#saveandprint').css("background-color",'red')
...
function changepooja(e){
	...
	$.ajax({
        ...
        success: function (data) {
            $.each(data, function (i, obj)
            {
            	html +='<option value="'+obj.pooja_id+'">'+obj.code+' '+obj.pooja+' - '+obj.pooja_mal+' - Rs '+obj.pooja_rt+'</option>';
            });
...
function check_dmyo(){
 ...
 function optionalfield(){
        ...
        if(dmyo==1){
           ...
           $('.week').hide();
           var selectedItems =[];
           var sta = $("#star_100").find(':selected').attr('data-name');
           console.log(sta);
           $('.monthstar').val(sta).trigger('change'); 
    ...
    function totalgross(){
        ...
        var pr_amt=($('#prasadam').val() == 1) ?  $('#parsel_amt').val() :  0;
