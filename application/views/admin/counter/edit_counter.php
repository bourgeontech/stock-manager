	        ...
	        <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
               <div class="row">
                  <div class="col-lg-12 col-md-12 col-sm-12 ">
                    <h2 class="page_txt"><i class="fa fa-plus-square-o" aria-hidden="true"></i>&nbsp;&nbsp;Edit Category </h2>
                  </div>
			   </div>
		       <form action="<?php echo base_url(); ?>index.php/admin/admin/edit_counter_settings/<?php echo $id;?>" method="post" >
      ...
      <div class="form_body">
        ...
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder=" Name" id="name" name="name" value="<?php echo $counter['name']?>" type="text" >
        ...
        <div class="form-group">
          <div class="row_form">
            ...
            <select class="sq_form"  id="printer" name="printer">
                <option <?php echo $counter['printer'] == 1 ? 'selected': ''; ?> value="1">Dot Matrix Printer</option> 
                <option <?php echo $counter['printer'] == 2 ? 'selected': ''; ?> value="2">Laser Printer</option> 
                <option <?php echo $counter['printer'] == 3 ? 'selected': ''; ?> value="3">Receipt Printer</option> 
            </select>
