			...
			<div class="row">
             ...
             <div class="col-lg-6 col-md-6 col-sm-6 ">
              ...
              <div class="col-lg-10 col-md-10 col-sm-10 ">
                  <form  action="<?php echo base_url();?>index.php/admin/pooja/bill_report_poojawise" method="post">
	         ...
	         <?php if(isset($bill_list)){?>
	          <div class="table-responsive">
                ...
                ?>
				  <tbody>
					<tr>
                     ...
                     <td><?= date("d-m-Y", strtotime($val['billingdate'])); ?></td>
               ...
               <td><?=$val['amount']; ?></td>      
					...
					<?php } ?>
               <tr><td colspan="5">&nbsp;</td><td> </td><td><?php echo $nos ;?> </td><td><?php echo $total ;?> </td></tr>
                <?php
                   }   else {
					?>	
