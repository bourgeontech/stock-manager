      ...
      <div class="form_body">
        <div class="row">  
		   ...
		   <div class="col-lg-12">
            ...
            <div class="col-md-12">
                <div class="form-group">
                   <button tabindex="12" type="submit" class="btn  pull-right" name="save" id="100" value="print" style="margin:7px 4px;background-color:#90EE90;" onfocus="test();"> Save &amp; Print </button>
                   <button tabindex="13" type="submit" class="btn btn-warning pull-right" name="save" value="save" style="margin:7px 4px;"> Save </button>
                </div>
          </div>
   ...
   function poojaSearch(data){
       ...
       $.ajax({
           ...
           success: function(data) {
                  ...
                  star = (typeof star === 'undefined') ? '0' : star;
                  var newRow = $("<tr>");
                  var cols = '';
                  cols += '<td>' + data.pooja + '<input name="pooja[]" value="' + data.pooja_id + '" type="hidden" required/>'; 
                  ...
                  cols +='<td><select name="star[]"  class="js-example-basic-single sq_form star" required style="width: 3.2cm;"><option value="0">Select Star</option>';
                  <?php foreach($birth_star as $val){ ?>
                  cols +='<option value="<?= $val['id']; ?>"><?= $val['name_eng']." - ".$val['name_mal']; ?></option>';
                  <?php } ?>
                  ...
                  cols += '<td><input readonly class="sq_form amt" name="amt[]" value="0.00" type="number" style="width: 70px;" required readonly/></td>';
