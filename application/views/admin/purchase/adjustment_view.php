		  ...
		  <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
			<div class="row">
              ...
              <div class="col-lg-8 col-md-8 col-sm-8 ">
                  <form  action="<?php echo base_url();?>index.php/admin/admin/adjustment_view" method="post">
                    <div class="input-group">
                      ...
                      <select name="product" id="product" class="form-control" style="margin:10px 0;">
				...
				<table class="table table-bordered table-hover text-nowrap" width="100%">
				  ...
				  <tbody>
					<tr>
					 ...
					 <td><a href="#"> <strong style="margin-bottom: 5px;display: block;color: #ea6227;"><?= $val['product_nm']; ?></strong></a></td>
					 <td><?= $val['unit']; ?></td>
					 <td style="text-align: right;"><?php if ($type=="-"){echo $type;} echo $val['qty']; ?></td>
