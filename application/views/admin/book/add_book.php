	        ...
	        <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
               <div class="row">
                  <div class="col-lg-12 col-md-12 col-sm-12 ">
                    <h2 class="page_txt"><i class="fa fa-plus-square-o" aria-hidden="true"></i>&nbsp;&nbsp;Add New Receipt Book </h2>
                  </div>
			   </div>
		       <form action="<?php echo base_url(); ?>index.php/admin/admin/add_book" method="post" >
      ...
      <div class="form_body">
        ...
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder=" Book No" id="book_no" name="book_no"  type="text" onchange="checkbook()">
        ...
        <div class="form-group">
          <div class="row_form">
            ...
            <textarea class="sq_form" row="4" name="remark"></textarea>
          </div>
        </div>
      </div>
           <div class="col-sm-12">
...
<script>
  ...
  function checkbook(){
    ...
    var url = "<?php echo base_url(); ?>index.php/admin/admin/checkduplicate";
    $.ajax({
        type: "GET",
        url: url,
        ...
        success: function (data) {
          if(data==1){
            alert('Book Number Already Exist');
            $('#book_no').val("");
            $('#book_no').focus();
          }
        }
