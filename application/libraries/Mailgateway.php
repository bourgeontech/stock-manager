...
class Mailgateway {
	...
	function sentExamScheduleMail($detail) {
        $send_to = $detail['email'];
        $msg = $detail['student_name'].'Exam Scheduled!';
        if ($send_to != "") {
  ...
  $msg = "Dear Parent, Your ward :" . $student_name . " of ".$student['class']."".$student['section']."was absent on date " . $student_detail['date'] . " Regards Attendance Department " . $school_name." Please do not directly reply to this email.Please contact class teacher for any clarification";
        return $msg;
    }
