    ...
    <div class="col-lg-12 col-md-12 col-sm-12">
        <form action="<?php echo base_url(); ?>index.php/admin/schedulebilling/multy_schedule_hierarchical_pooja" method="post" id="multi-schedule-form">
            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    <div class="form_body">
                        <div class="row mb-5 card p-2" id="dvPassport">
                            <div class=" h-100 p-2">
                                <?php 
                            ...
                            <div class="product-description-tab">
                                <div class="description-tab-menu">
                                    <ul class="clearfix" role="tablist">
                                      ...
                                      <li role="presentation" id="custom_1" onclick="showschedule('custom')"><a href="#custom" aria-controls="custom" role="tab" data-toggle="tab">Custom</a></li>
                                   </ul>
                                </div>
...
<script>
    ...
    $( ".adddays" ).keyup(function() {
         ...
         const dateto = new Date(new Date(datefrom).setDate(datefrom.getDate() + x))
