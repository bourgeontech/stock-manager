              ...
              <div class="col-lg-8 col-md-8 col-sm-8 ">
                  <form  action="<?php echo base_url();?>index.php/admin/admin/bill_report" method="post">
                    <div class="input-group">
                      <input type="date" class="form-control" value="<?php if(isset($date)){echo $date;}else{echo (new DateTime('now'))->modify('+1 day')->format('Y-m-d');}?>" required name="keyword" style="margin:10px 0;">
            		  ...
            		  <select name="ampm" id="ampm" class="form-control" style="margin:10px 0;height:auto;">
            			  ...
            			  <option value="M" <?php if(isset($ampm)=="M"){echo "Selected";}?>>Morning</option>
                           <option value="8" <?php if(isset($ampm)=="8"){echo "Selected";}?>>8</option>
                      ...
                      <div class="input-group-append" style="margin:10px 0;">
                        ...
                        <button type="submit" class="btn btn-outline-secondary" name="serch" value="deity_wise" title="Deity Wise Print"><i class="fa fa-print" aria-hidden="true"></i></button>
                      </div>
                    </div>
                  </form>
              </div>
				...
				<table class="table table-bordered table-hover text-nowrap" width="100%">
				  ...
				  <tbody>
					<tr>
                     ...
                     <td><?= $val['name']; ?></td>
					 <td><?= base_url() == 'https://kaladyshankaramadomts.org/' ? $val['star_eng'] : $val['star_mal']; ?></td>
					 <td><?= base_url() == 'https://kaladyshankaramadomts.org/' ? $val['pooja_eng'] : $val['pooja_nm']; ?></td>
					 <td><?= $val['qlt']; ?></td>
					</tr>
				  </tbody>
					<?php } }
