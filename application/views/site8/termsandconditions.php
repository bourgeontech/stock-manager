        ...
        <div class="home_welcome">
          <div class="row">
            <div class="col-lg-12">
             ...
             <h2 class="title1 title1_left">Terms and Conditions</h2>
             
               <div class='inner_pak'>
               
                      <div class="board depat my-div-quick">
                      
<!--                     <iframe src="<?php// echo base_url(); ?>/assets/new_site/docs/Terms&Conditions.pdf" width="100%" height="320px">
                    </iframe> -->
                    <hr><h5>OVERVIEW</h5><hr>
                    <p>
This website is operated by <?php print_r($temple_list[0]['name']);?> Temple. Throughout the site, the terms
"we", "us" and "our" refer to <?php print_r($temple_list[0]['name']);?>. S<?php print_r($temple_list[0]['name']);?> temple
offers this website, including all information, tools and services available from this site to you, the
...
Our temple website is hosted on Bourgeon Innovations Pvt Ltd . They provide us with the
online e-commerce platform that allows us to sell our products and services to you.
</p>
<hr><h5>SECTION 1 ONLINE SERVICES TERMS</h5><hr>
<p>
...
You may not use our services or products for any illegal or unauthorized purpose nor may you, in the
...
<hr><h5>SECTION 2 - GENERAL CONDITIONS</h5><hr>
<p>
...
adapt to technical requirements of connecting networks or devices. Credit card information if
collected will always be encrypted during transfer over networks.
...
provided, without express written permission by <?php print_r($temple_list[0]['name']);?>.
The headings used in this agreement are included for convenience only and will not limit or otherwise
affect these Terms.
</p>
<hr><h5>SECTION 3 - ACCURACY, COMPLETENESS AND TIMELINESS OF INFORMATION</h5><hr>
<p>
...
<hr><h5>SECTION 4 - MODIFICATIONS TO THE SERVICE AND PRICES</h5><hr>
<p>
...
<hr><h5>SECTION 5 - PRODUCTS OR SERVICES (if applicable)</h5><hr>
<p>
...
right to limit the quantities of any products or services that we offer. All descriptions of services,
products or their pricing are subject to change at any time without notice, at the sole discretion of us.
We reserve the right to discontinue any product and service at any time.
</p>
<hr><h5>SECTION 6 - ACCURACY OF BILLING AND ACCOUNT INFORMATION</h5><hr>
<p>
We reserve the right to refuse any order you place with us. We may, in our sole discretion, limit or
cancel quantities purchased per person. In the event that we make a change to or cancel an order,
...
sole judgment, appear to be placed by unauthorized persons or companies.
You agree to provide current, complete and accurate purchase and account information for all
purchases made at our temple. You agree to promptly update your account and other information,
including your email address and phone number, so that we can complete your transactions and
contact you as needed.
For more detail, please review our Returns Policy.
</p>
<hr><h5>SECTION 7 - USER COMMENTS, FEEDBACK AND OTHER SUBMISSIONS</h5><hr>
<p>
...
<hr><h5>SECTION 8 - PROHIBITED USES</h5><hr>
<p>
...
<hr><h5>SECTION 9 - DISCLAIMER OF WARRANTIES; LIMITATION OF LIABILITY</h5><hr>
<p>
...
<hr><h5>SECTION 10 - INDEMNIFICATION</h5><hr>
<p>
You agree to indemnify, defend and hold harmless <?php print_r($temple_list[0]['name']);?> and
employees, harmless from any claim or demand, including reasonable attorneys' fees, made by any
third-party due to or arising out of your breach of these Terms of Service or the documents they
incorporate by reference, or your violation of any law or the rights of a third-party.
</p>
<hr><h5>SECTION 11 - TERMINATION</h5><hr>
<p>
...
<hr><h5>SECTION 12 - GOVERNING LAW</h5><hr>
<p>
...
<hr><h5>SECTION 13 - CHANGES TO TERMS OF SERVICE</h5><hr>
<p>
...
<hr><h5>SECTION 14 - CONTACT INFORMATION</h5><hr>
<p>
Questions about the Terms of Service should be sent to us at <?php print_r($getcontact[0]['email']);?>.
                    </p>
