    ...
    <div class="page-header">
       ...
       <div class="row">
	     <div class="col-lg-12 col-md-12 col-sm-12 ">		 
	        <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
               <div class="row">
                  <div class="col-lg-12 col-md-12 col-sm-12 ">
                    <h2 class="page_txt"><i class="fa fa-plus-square-o" aria-hidden="true"></i>&nbsp;&nbsp;Add New Content </h2>
                  </div>
			   </div>
      ...
      <div class="col-lg-12">
        <div class="form-group">
          <!-- <div class="row_form"> -->
            <div class="div_label">
              <label class="text_label">Short Description [ For Home Page ] <span class="red"> *</span></label>
            </div>
            <textarea class="" id="content" name="short_content" rows="3" style="width: 100%;"><span></span></textarea>
      ...
      <div class="col-lg-12">
        <div class="form-group">
          <!-- <div class="row_form"> -->
            ...
            <textarea class="" id="content" name="content" rows="6" style="width: 100%;"><span></span></textarea>
			  <?php echo form_error('content', '<div class="error">', '</div>'); ?>
          </div>
        <!-- </div> -->
      </div>		
