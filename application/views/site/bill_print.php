     ...
     //   $site_settings=$this->site_model->settings();
			...
			<table border="1" style="border-collapse:collapse;width:98%;margin-bottom:1cm;font-size:14px;">
                ...
                $bstatus=$query['0']['bstatus'];
                 ...
                 <tr>
				        <th colspan="9"style="text-align: right;margin-bottom:1cm;" >DEVASWOM OFFICER </th>
				    </tr>
...
<script>
window.onfocus = function () { setTimeout(function () { window.location = "<?php echo base_url();?>index.php/welcome/thankyou/<?= $bill_id;?>" }, 500); }
function myFunction(){
    window.location = "<?php echo base_url();?>index.php/welcome/thankyou/<?= $bill_id;?>";
}
