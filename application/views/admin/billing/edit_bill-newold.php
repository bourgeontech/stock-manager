...
<div class="side_right">
   ...
   <!--     </div>-->
    ...
    {
    if ($diff_minutes > 10 ) {
        $this->session->set_flashdata('error', 'You cannot edit this bill. It was created more than 10 minutes ago.');
        				...
        				<table class="table table-responsive-sm">
                        	...
                        	<tbody>
                				<tr>
                					...
                					<td> <input type="text" class="form-control" name="customer_details[email]" value="<?php echo $customer[0]['email']; ?>" /> </td>
