    ...
    // $site_settings=$this->site_model->settings();
          ...
          foreach ($dates as $date){
		    ...
		    foreach ($pooja_cat as $id){
		        $this->db->select('billing_dtls.*,stars.name_mal as star_eng,pooja.name as pooja_nm,billing_dtls.rate as pooja_rt,diety.name_mal as deity_nm');
...
//         	    if(count($query)>0){
         ...
         <div class="fixed-header"></div>
			<table border="0" style="border-collapse:collapse;width:100%;margin-bottom:1cm;font-size: 15px;color:black;">
			    <thead>
    				<!--<tr>
				    ...
				    foreach($query as $val){ 
                     ...
                     $amt=$val['amount'];
                      ...
                      $amount=$val['amount'];
                        ...
                        <td width="30%"><?php echo $val['pooja_nm']; if ($date!=$today){echo "(".date('d-m-Y',strtotime($date)).")";}?></td>
				            <td width="30%"><?php echo strtoupper($val['name']);?></td>
				            <td width="10%"><?php echo $val['star_eng'];?></td>
