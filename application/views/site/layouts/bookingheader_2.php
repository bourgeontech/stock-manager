        ...
        <div class="container">
          <div class="menu_block">
            ...
            <ul>
            	...
            	<?php if($this->session->userdata('customer') && is_object($this->session->userdata('customer'))): ?>
            	<li><a href="<?php echo base_url(); ?>index.php/customer/account"><span> My Account </span></a></li>
            	<?php else: ?>
            	<li><a href="<?php echo base_url(); ?>index.php/customer/login"><span>User Login</span></a></li>
            	<?php endif; ?>
              </ul>
            </div>
          </div>
