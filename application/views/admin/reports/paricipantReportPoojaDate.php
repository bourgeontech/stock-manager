  <div class="side_right">
    ...
    <div class="page-header">
        <div class="col-lg-6 col-md-6 col-sm-6 ">
          <h4 class="page_txt">Participation Report By Pooja Date</h4>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6 ">
		  ...
		  <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
			<div class="row">
             ...
             <div class="col-lg-6 col-md-6 col-sm-6 ">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12">
                  <form  action="<?php echo base_url();?>index.php/admin/report/poojaParticipationReportByPoojaDate" method="post">
	          ...
	          <div class="table-responsive" id="printer" onafterprint="myFunction()">
               ...
               <?php $total_qty = 0; $grand_total = 0; $grand_total_cash=0; $grand_total_qr=0; $grand_total_card=0; $grand_total_mo=0; $grand_total_neft=0; $grand_total_app=0;$grand_total_online=0;?>
				  ...
				  <tbody>
					<tr>
					  <td><?= $key+1;?></td>
                      <td> <a href="<?php echo base_url(); ?>index.php/admin/admin/edit_bill/<?= $val->bill_id; ?>" class="text-orange"> <b> Bill - <?= $val->bill_id; ?> </b> </a></td>
                      <td>&nbsp;<?= $val->name;?></td>
              		  <td>&nbsp;<?=  $val->star;?></td>
                      <td>&nbsp;<?=  $val->pooja;?></td>
