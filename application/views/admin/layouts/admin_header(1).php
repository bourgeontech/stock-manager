...
<!--            							<a class="btn btn-success " id="availability_calendar" data-toggle="modal" href="" onclick="event.preventDefault();">Pooja Availability Calendar</a> -->
           							<a class="btn btn-success " href="<?php echo base_url();?>index.php/admin/admin/pooja_calendar" >Pooja Availability Calendar</a>
                                	<a class="btn btn-success " href="<?php echo base_url();?>index.php/cms/database_backup" >Database Backup</a>
                            	</nav>
                            	  <script>
						...
						<div class="horizontal-mainwrapper container clearfix">
							<nav class="horizontalMenu clearfix">
								<ul class="horizontalMenu-list">
									...
									?>
									<li aria-haspopup="true"><a href="#" class="sub-icon"><i class="fe fe-settings"></i> Pooja Settings &nbsp;&nbsp;<i class="fa fa-angle-down horizontal-icon"></i></a>
										<ul class="sub-menu">
											<?php 
        									if (in_array("add_diety", $pemission)
        									    ||in_array("diety_view", $pemission)
											...
											if (in_array("kooru_usr", $pemission)
											    ...
											    ||in_array("kooru_rpt", $pemission)){
											?>
											<li aria-haspopup="true" class="sub-menu-sub"><a href="#">Kooru Management</a>
												<ul class="sub-menu">
													<?php 
													if (in_array("kooru_usr", $pemission)){
												    ?>
												    ...
												    ?>
													<li aria-haspopup="true"><a href="<?php echo base_url();?>index.php/admin/admin/kooru_mng">Kooru</a></li>
													<?php 
													}if (in_array("kooru_rpt", $pemission)){
												    ?>
													<li aria-haspopup="true"><a href="<?php echo base_url();?>index.php/admin/admin/kooru_rpt">Report</a></li>
                                                	<li aria-haspopup="true"><a href="<?php echo base_url();?>index.php/admin/report/date_wise_kooru_rpt">Date Wise Report</a></li>
                                                	<?php 
													}
												    ?>
												</ul>
									...
									<li aria-haspopup="true">
            							<a href="#" class="sub-icon"><i class="fe fe-codepen"></i>Customer &nbsp;&nbsp;<i class="fa fa-angle-down horizontal-icon"></i></a>
            							<ul class="sub-menu">
            								<?php 
								            if (in_array("add_customer", $pemission)){
										    ?>
            						...
            						<li aria-haspopup="true">
            							...
            							<ul class="sub-menu">
                                            ...
                                            <li aria-haspopup="true"><a href="<?php echo base_url();?>index.php/admin/admin/other_billing">Other Billing</a></li>
										    ...
										    ?>
                                           <li aria-haspopup="true"><a href="<?php echo base_url();?>index.php/admin/billing/multy_schedule">Multy Schedule </a></li>
            								<?php 
											...
											<?php 
								            }if (in_array("deleted_bill", $pemission)){
										    ?>
                                            ...
                                            <li aria-haspopup="true" class="sub-menu-sub"><a href="#">View Bills &amp; Reports</a>
												<ul class="sub-menu">
                    								...
                    								<?php 
        								            }if (in_array("user_wise", $pemission)){
        								                ?>
                                            ...
                                            <li aria-haspopup="true" class="sub-menu-sub"><a href="#">Pooja Reports</a>
                                                ...
                                                <li aria-haspopup="true"><a href="<?php echo base_url();?>index.php/admin/admin/bill_report">Deity wise Pooja wise List</a></li>
                                                 <li aria-haspopup="true"><a href="<?php echo base_url();?>index.php/admin/admin/bill_report_poojawise">Deity wise Single Pooja Report</a></li>
                    								<?php 
											...
											?>
											<li aria-haspopup="true" class="sub-menu-sub"><a href="#">Bandaram</a>
												<ul class="sub-menu">
                    								<?php 
        								            if (in_array("bandaram", $pemission)){
        										    ?>
													<li aria-haspopup="true"><a href="<?php echo base_url();?>index.php/admin/admin/bandaram">Bandaram</a></li>
                    								<?php 
                               	...
                               	<li aria-haspopup="true"><a href="#" class="sub-icon"><i class="fa fa-cat"></i> Inventory &nbsp;&nbsp;<i class="fa fa-angle-down horizontal-icon"></i></a>
												<ul class="sub-menu">
        											<?php 
                                                    if (in_array("inv_cat", $pemission)){
            										?>
