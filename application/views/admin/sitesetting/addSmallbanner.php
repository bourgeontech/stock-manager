 ...
 <div class="side_right">
    ...
    <div class="page-header">
        <div class="col-lg-6 col-md-6 col-sm-6 ">
          <h2 class="page_txt"> Banner image </h2>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6 ">
       ...
       <div class="row">
	     <div class="col-lg-12 col-md-12 col-sm-12 ">		 
	        <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
               <div class="row">
                  <div class="col-lg-12 col-md-12 col-sm-12 ">
                    <h2 class="page_txt"><i class="fa fa-plus-square-o" aria-hidden="true"></i>&nbsp;&nbsp;Update Banner image </h2>
                  </div>
			   </div>
               <?php echo form_open_multipart("cms/addSmallbanner"); ?>
