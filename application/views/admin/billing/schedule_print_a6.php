...
<script>
window.onfocus = function () { setTimeout(function () { window.location = "<?php echo base_url();?>index.php/admin/schedulebilling/multy_schedule_hierarchical_pooja" }, 500); }
function myFunction(){
    window.location = "<?php echo base_url();?>index.php/admin/schedulebilling/multy_schedule_hierarchical_pooja";
}
