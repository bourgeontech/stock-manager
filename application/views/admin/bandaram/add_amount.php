	        ...
	        <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
               <div class="row">
                  <div class="col-lg-12 col-md-12 col-sm-12 ">
                    <h2 class="page_txt"><i class="fa fa-plus-square-o" aria-hidden="true"></i>&nbsp;&nbsp;Add Amount </h2>
                  </div>
			   </div>
		       <form action="<?php echo base_url(); ?>index.php/admin/admin/amount" method="post" >
      ...
      <div class="col-lg-12">
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder=" Order" id="order" name="order" type="number" min="1" >
      ...
      <div class="col-lg-12">
        <div class="form-group">
          <div class="row_form">
            ...
            <textarea rows="3" class="sq_form" id="remark" name="remark"></textarea>
