...
<!--                                 <th style="text-align:right;"><span onclick="addRow()"><i class="fa fa-plus" style="padding: 8px;"></i></span></th> -->
                            ...
                            <tr>
                                ...
                                <td><input type="text" name="ben_name" id="name_100" class="sq_form" placeholder="Name" value="" required style="width: 3.2cm;" onchange="nameadd();"></td>
                                <td><select name="star_id" id="star_100" class=" sq_form" required style="width: 3.2cm;">
                                ...
                                <td><select name="pooja_id" id="pooja_100" onchange="change_rate(100)"  onload="change_rate(100)" class="sq_form ">
                                    <option value="0">Please Select</option>
                                </select></td>
                                <td><input type="hidden" value="100" id="row_value">
                                    <input id="qlt_100" type="number" min="1" name="qlt" onchange="change_rate(100),checkallowedqty(100)" onkeyup="change_rate(100),checkallowedqty(100)"  class="sq_form" placeholder="Quatity" value="1" readonly></td>
        ...
        <!-- <div style="align: center;" class="form_body">
          ...
          <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative">
               ...
               <tr>
                                           ...
                                           <td><input type="text" name="house_name" id="house_name" class="sq_form" placeholder=""  value=""></td>
                                           <td><input type="text" name="post" id="post" class="sq_form" placeholder=""  value=""></td>
                                        </tr>
                                        <tr>
                                                <th>Place</th>
                                                <th>Pincode</th>
                                         ...
                                         <tr>
                                           <td><input type="text" name="street" id="street" class="sq_form" placeholder=""  value=""></td>
                                           <td><input type="text" name="pincode" id="pincode" class="sq_form" placeholder=""  value=""></td>
                                           <td><input type="text" name="district" id="district" class="sq_form" placeholder=""  value=""></td>
                                           <td><input type="text" name="email" id="email" class="sq_form" placeholder=""  value=""></td>
                                        </tr>
                                    </table>
                                 </div>  
     	...
     	if(e.keyCode == 9) {
        	...
        	if($("#name_100").is(':focus') == true){
            	...
            	$.ajax({
                	...
                	success: function(data) {
                    	console.log(data)
                <?php  if ($url!='mookkuthalabhagavathitemple.com'){?>
                    	$("#name_100").val(data.name); <?php } ?>
                	}
            	});
