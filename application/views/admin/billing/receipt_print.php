            ...
            <hr>
                    <table>
                     ...
                     <tbody>
                       ...
                       <tr>
                         <td class="description" style="font-weight:bold;font-size:15px;">
...
echo $output;
						     ...
						     <?php } else { ?>
                         	 ...
                         	 <?php } ?>
                             <br>
                             (<?php echo $qlt;?> * <?php echo $pooja_rt;?>) | <?php print_r(date('d-m-Y',strtotime($val['date'])));?> | <?php echo $val['time'];?><br>
                         </td>
