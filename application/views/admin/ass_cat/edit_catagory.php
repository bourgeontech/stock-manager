    ...
    <div class="row">
	     <div class="col-lg-4 col-md-4 col-sm-4 ">		 
	        <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
		       ...
		       <form action="<?php echo base_url(); ?>index.php/admin/admin/edit_ass_cat/<?php echo $id;?>" method="post" >
				  ...
				  <tbody>
					<tr>
					  ...
					  <td><div class="btn-group">
						  <a href="<?php echo base_url();?>index.php/admin/admin/edit_ass_cat/<?= $val['id']; ?>" class="btn btn-outline-info" style="padding:6px;" title="Edit"> <i class="fa fa-edit"></i></a> 
						  <a href="<?php echo base_url();?>index.php/admin/admin/delete_ass_cat/<?= $val['id']; ?>"   onclick="return confirm('Are you sure you want to delete?')"
