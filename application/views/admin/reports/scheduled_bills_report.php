       ...
       <div class="row">
	     <div class="col-lg-12 col-md-12 col-sm-12 ">
		  <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
			<div class="row">
              <div class="col-lg-6 col-md-6 col-sm-6 ">
                <h2 class="page_txt"><i class="fa fa-list-ol" aria-hidden="true"></i>&nbsp;&nbsp;Scheduled Bills</h2>
              </div>
             <div class="col-lg-6 col-md-6 col-sm-6 ">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12">
                  <form  action="<?php echo base_url();?>index.php/admin/report/schedule_bills" method="post">
                    <div class="input-group">
					  ...
					  <input type="text" class="form-control" value="<?php if(isset($keyword)){echo $keyword;}?>" placeholder="Search Keyword" name="keyword" style="margin:10px 0;">
	          ...
	          <div class="table-responsive" id="printer" onafterprint="myFunction()">
              	<table class="table table-bordered table-hover text-nowrap" width="100%">
    				...
    				<tr>
    					<th colspan="5"><label style="text-align:center;">Scheduled Bills From : <?php echo date('d-m-Y',strtotime($datef));?></label>
				  ...
				  <thead>
					<tr>
                    	...
                    	<th style="width: 10%">Total</th>
					  	<th scope="col" style="text-align:right; width: 15%">Action</th>
					</tr>
				  </thead>
					<?php 
				  ...
				  <tbody>
					<tr>
					 ...
					 <td style="text-align:right">
                    	<div class="btn-group">						  
                             <a href="<?= base_url('index.php/admin/report/schedule_bills_details/'.$val['bill_no']); ?>" class="btn btn-outline-info" style="padding:6px;" title="Details"> <i class="fa fa-eye"></i></a> 
						</div>
                     </td>
					</tr>
				  </tbody>
