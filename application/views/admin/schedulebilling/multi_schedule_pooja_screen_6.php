                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="row_form">
                                            ...
                                            <input class="sq_form" placeholder=" Name Locale" id="name_locale" name="name_locale[]"  type="text" >
                                    ...
                                    <div class="form-group">
                                      <div class="row_form">
                                        <div class="div_label">
                                      	...
                                      	<select name="star_id[]" class="sq_form" id="search_star">
                                        	<?php foreach($star_list as $star): ?>
                                        	<option value="<?php echo $star['id']; ?>" data-name="<?php echo $star['name_eng']; ?>"><?php echo $star['name_eng'].' - '.$star['name_mal'].' | '.$star['id']; ?></option>
                                        	<?php endforeach; ?>
                                        </select>
                                        ...
                                        <div class="card bg-light mb-0">
                                            <table class="table table-hover mr-auto mb-0" width="25%">
                                                ...
                                                <tr class="ifYes">  
                                                    ...
                                                    <td colspan="3"> 
                                                    	<input type="radio"  name="postal_type" class="postal_type" value="normal" data-rate="<?php print_r($postal_charge);?>" checked /> Normal
                                                    	<input type="radio"  name="postal_type" class="postal_type" value="airmail" data-rate="<?php print_r($airmail_charge);?>"  /> Courier
                                                	</td>
                                                </tr>
                                                <tr class="ifYes">
...
<script>
	...
	$('.postal_type').on('change', () => {
		var rate = $('.postal_type:checked').data('rate');
        $('#postel_rate').val(rate)
    });

	$('#search_star').on('change', (e) => {
    	let value = e.target.value;
    	let name  = $('#search_star').find('option:selected').data('name'); 
