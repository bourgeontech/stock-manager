                      ...
                      <div class="accordion_d">
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-6">
                            ...
                            <?php  $fourth_date = date('Y-m-d', strtotime("+4 day")); ?>
                              <input type="date" name="main_date" class="form-control" min="<?php echo $fourth_date?>" AutoComplete="off" onfocus="blur()" value="<?php echo $fourth_date;?>" id="main_date">
                            </div>
                          </div>
                          <div class="col-sm-6">
                            <div class="form-group">
                    ...
                    <div class="col-lg-4">
                      <div class="mybooking cart">
                        ...
                        <div class="cart_details">
                          ...
                          <div class="text-center"> <a ID="btn_discard" class="btn btn-outline-warning w-100" href="<?php echo base_url(); ?>index.php/welcome/discard" style="text-align: center;">Discard</a> </div>
                        </div>
                      </div>
                    </div>
                  </div>
