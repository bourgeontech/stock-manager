...
<div class="side_right">
    ...
    <div class="page-header">
       ...
       <div class="row">
       <form action="<?php echo base_url(); ?>index.php/accounts/dayinvclosing" method="post">  <div class="col-lg-12 col-md-12 col-sm-12 "><label style="color: teal;font-weight: 500;">Choose the date</label><input type="date" id="invdate" name="invdate">
       <input type="submit" name="submit" class="btn btn-success" value="Submit"></div></form>
	     <div class="col-lg-12 col-md-12 col-sm-12 ">
		  <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
	      <form action="<?php echo base_url(); ?>index.php/accounts/inv_post" method="post">  <div class="table-responsive">
	     ...
	     <div class="col-lg-12 col-md-12 col-sm-12 ">
		  <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
	       <div class="table-responsive">
			...
			<div class="table-responsive">
       			<strong>Dittum for <?php echo $today;?></strong>
            <input type="hidden" name="invdate" value="<?php echo $today;?>">
...
<!--     				</tr> -->
     ...
     <td><a href="#"> <strong style="margin-bottom: 5px;display: block;color: #ea6227;"><?= $pooja['pooja']; ?></strong></a></td>
             ...
             <div style="text-align:center;">
            	<input type="submit" name="submit" class="btn btn-success" value="Verify &amp; Post to Stock"> 
         	 </div>
			</div> 
          </div>
	    </div>
