...
<!--                                 <th style="text-align:right;"><span onclick="addRow()"><i class="fa fa-plus" style="padding: 8px;"></i></span></th> -->
                            ...
                            <tr>
                                ...
                                <td>
                                   <input type="text" name="search_pooja" class="sq_form" id="searchpooja" placeholder="Search Pooja By Code/Name" />
                                    ...
                                    <table class="table table-responsive-sm">
                                        ...
                                        <tbody id="dataTable2">
                                            <tr>
                                                ...
                                                <td class="star"><select name="star[]" id="month"  class=" sq_form  select2 monthstar"  multiple>
                                                        <option value="">Select Star</option>
                                                    <?php foreach($star_list as $val){ ?>  
          ...
          <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative">
               <table class="table  srp_table" width="100%">
                                            <tr>
                                                ...
                                                <th>Place</th>
                                           <tr>
                                           <td><input style="border-color: red;" type="text" name="name" class="sq_form" placeholder="" required  value=""></td>
...
function check_dmyo(){
 ...
 function optionalfield(){
        ...
        if(dmyo==1){
           ...
           $('.day').hide();
           $('.week').hide();
           var sta = $('.firststar').val();
           // $('.monthstar').val(sta); 
           // $('.monthstar').trigger('change');
