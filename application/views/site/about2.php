  ...
  <div class="container">
    <div class="about-intro fade-up">
      <div class="ai-img-col">
        <img class="ai-img" src="../../uploads/aboutus/<?PHP echo $value['image']; ?>" alt="Aai Tulja Bhavani Mandir">
      ...
      <div class="ai-text">
        ...
        <p class="intro-para"><strong> <?php echo $value['title'];?></strong>  <?php echo nl2br($value['content']);?></p>
