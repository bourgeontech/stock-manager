    ...
    <div class="page-header">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 ">
          <ul class="btn_ul" style="float:right;">
            <li> <a href="<?php echo base_url();?>index.php/accounts/viewcontra" class="btn btn-primary">View&nbsp;&nbsp;<i class="fa fa-eye" aria-hidden="true"></i></a> </li>
          </ul>
        </div>
    </div>
       <div class="row">
	     <div class="col-lg-12 col-md-12 col-sm-12 ">
		  <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
			<div class="row">
              <div class="col-lg-6 col-md-6 col-sm-6 ">
                <h2 class="page_txt"><i class="fa fa-list-ol" aria-hidden="true"></i>&nbsp;&nbsp;Add Contra </h2>
              </div>
			 </div>	
               <br>

		       <form action="<?php echo base_url(); ?>index.php/accounts/addcontra" method="post" onsubmit="return validateForm()" id="myform">
          ...
          <div class="row_form">
            	<table class="table table-responsive-sm">
            		...
            		<tbody id="dataTable2">
                        ...
                        <td><input type="text" name="voucher_no[]" id="voucher_no_100" class="sq_form" placeholder="Voucherno" value="" ></td>
                      		<td><input type="text" name="amount[]" id="name_100" class="sq_form" placeholder="Amount" value="" required></td>
