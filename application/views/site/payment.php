                            	...
                            	<table class="table table-hover" width="100%" border="1">
                                	...
                                	<tfoot>
                                        ...
                                        <tr>
                                            ...
                                            <th style="text-align:right" id="total"><?php echo $total_amd=$total_tax+$bill_list[0]['total'];?></th>
                                        </tr>
                                        <tr>
                        ...
                        <div class="title"><i class="fa fa-cart-arrow-down"></i> User Details </div>
                            <div class="d-flex align-items-center justify-content-center" style="padding:1cm;">
                                <div class="entries-info text-center">
                                    ...
                                    <p><?php echo $user_list[0]['house']." , ".$user_list[0]['street']." , ".$user_list[0]['post'];?>,</p>
                                    <p><?php echo $user_list[0]['district']." , ".$user_list[0]['state'];?>.</p>
                                    <p><?php echo $user_list[0]['pincode']." , ".$user_list[0]['email'];?>,</p>
                                </div>
                            </div>
...
<script>
    var options = {
       "key": "rzp_live_5d2La9FhpIFuVu",
      
		//"key":"rzp_test_yt3A6ZaVAibIKS",
		"amount": "<?php echo $total_amd*100; ?>",
        "name": "Mookuthala Temple",
