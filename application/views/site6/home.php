  ...
  <div class="container">
    <div class="row">
      <div class="col-sm-12 text-center">
        ...
        <input name="" type="button" value="Read More" class="btnReadMoreWhite" onclick = "window.location.href='<?php echo base_url(); ?>index.php/welcome/temple#about';"
        >
      </div>
    </div>
  </div>
      ...
      <div class="col-sm-6">
        <div class="row">
          ...
          <div class="col-sm-6 poojaTimesTxtHolder">
            ...
            <input name="" type="button" value="Click Here" class="btnReadMoreWhite" onclick="url_redirect_common('index.php/welcome/poojas#timing')">
            <!--2017-12-04 Start-->
          ...
          <div class="col-sm-6 mainOfferingTxtHolder">
            ...
            <input name="" type="button" value="Click Here" class="btnClickHereYellow" onclick="url_redirect_common('index.php/welcome/poojas#vazhipadu')">
            <!--2017-12-04 Start-->
