      ...
      <div class="container main-sec" >
        <div class="ct_header">
          <div class="row" style="background: <?php echo $site_settings['menucolor']; ?>99;">
            ...
            <a class="logo text-left" style="font-size:16px;font-weight:bold;text-transform:uppercase;"><?php print $site_settings['templename_mal']; ?><br><?php print $site_settings['templename_eng']; ?></a></h5>
            </div>
            <div class="col-lg-5">
              <div class="info">
                <div class="info_img"> <?php if($_SERVER['HTTP_HOST']=='ayyappadevalayamtaramattipeta.com'){ ?><img src="<?php echo base_url(); ?>/assets/new_site/images/icons/at.jpg" title="" alt="" width="40px" height="52px"> <?php } else {?> <img src="<?php echo base_url(); ?>/assets/new_site/images/icons/icons5.png" title="" alt="" width="40px" height="52px"> <?php } ?></div>
        ...
        <div class="col-lg-3">
        	...
        	<?php if($_SERVER['HTTP_HOST']!='ayyappadevalayamtaramattipeta.com'){ ?>	
        <!--    <div class="outlined-clickandcollect">  <a href="<?php echo base_url(); ?>index.php/worldline/donation" class="btn_booking">ONLINE DONATION</a> </div>
        		<div class="outlined-clickandcollect">  <a href="<?php echo base_url(); ?>index.php/donation/booking" class="btn_booking">E-KANIKKA</a> </div><?php } ?>
       --> 	</div>
        </div>
          </div><?php } ?>
        </div>
          ...
          <div class="menu_block">
            ...
            <ul>
                ...
                <li class="has-sub"><a href="#"><span>The Temple</span></a>
                  <ul>
                    <li><a href="<?php echo base_url(); ?>index.php/welcome/aboutUs"><span>About Temple</span></a> </li>
                  <?php if($_SERVER['HTTP_HOST']!='ayyappadevalayamtaramattipeta.com'){ ?> <li><a href="<?php echo base_url(); ?>index.php/welcome/priest"><span>Temple Priest</span></a> </li><?php } ?>
                    <li><a href="<?php echo base_url(); ?>index.php/welcome/trusteeboard"><span>Trustee Board</span></a> </li>
              <?php if($_SERVER['HTTP_HOST']!='ayyappadevalayamtaramattipeta.com'){ ?>  
                  <li><a href="<?php echo base_url(); ?>index.php/welcome/festivalCommittee"><span>Festival Committee</span></a> </li><?php } else { ?> <li><a href="<?php echo base_url(); ?>index.php/welcome/festivalCommittee"><span>Working Committee</span></a> </li><?php } ?>
                 <?php if($_SERVER['HTTP_HOST']!='ayyappadevalayamtaramattipeta.com'){ ?>	      <li><a href="<?php echo base_url(); ?>index.php/welcome/paripalanaSamithi"><span>Paripalana samithi</span></a> </li><?php } ?>
                  </ul>
                </li>
                <li class="has-sub"><a href="#"><span>Pooja</span></a>
                  <ul>
                    <li><a href="<?php echo base_url(); ?>index.php/welcome/dietys"><span>DEITIES</span></a> </li>
                    <li><a href="<?php echo base_url(); ?>index.php/welcome/templeTiming"><span>TEMPLE TIMING</span></a> </li>
                  </ul>
                </li>
                     <li><a href="<?php echo base_url(); ?>index.php/welcome/eventFestival"><span>Event Festival</span></a></li>
                <li><a href="<?php echo base_url(); ?>index.php/welcome/news"><span>News</span></a></li>
                <li class="has-sub"><a href="#"><span>Other Info</span></a>
                  <ul>
                    <li><a href="<?php echo base_url(); ?>index.php/welcome/announcements"><span>Announcements</span></a> </li>
                    <li><a href="<?php echo base_url(); ?>index.php/welcome/rules"><span>Temple Rules</span></a> </li>
                  </ul>
                </li>
                <li><a href="<?php echo base_url(); ?>index.php/welcome/gallery"><span>Gallery</span></a></li>
                <li class="last"><a href="<?php echo base_url(); ?>index.php/welcome/contact"><span>Contact Us</span></a></li>
              </ul>
            </div>
          </div>
        </div>
