<div class="side_right">
       ...
       <div class="row">
	     <div class="col-lg-12 col-md-12 col-sm-12 ">
		  <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
			<div class="row">
              <div class="col-lg-6 col-md-6 col-sm-6 ">
                <h2 class="page_txt"><i class="fa fa-list-ol" aria-hidden="true"></i>&nbsp;&nbsp;Add Payment </h2>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-6 ">
        <div class="header">
  <div class="header-right">
 	<h5>Last Vocher No: <?= $voucher_no; ?></h5>
		       ...
		       <form action="<?php echo base_url(); ?>index.php/accounts/addPayment" method="post" onsubmit="return validateForm()" id="myform">
            	...
            	<table class="table table-responsive-sm">
            		...
            		<tbody id="dataTable2">
                      ...
                      <?php } ?>
                			...
                			<td><input type="text" name="narration[]" id="narration_100" class="sq_form" placeholder="Narration" value=""></td>
