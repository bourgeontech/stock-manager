		  ...
		  <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
			<div class="row">
             ...
             <div class="col-lg-6 col-md-6 col-sm-6 ">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12 ">
                  <form  action="<?php echo base_url();?>index.php/admin/admin/user_wise_pooja" method="post">
                  	<?php 
                    ...
                    <div class="input-group">
                      <select id="type" name="type" class="form-control" autofocus="autofocus" style="margin:10px 0;">
                          <option value="">Select Type *</option>
                      	  <?php if($this->db->table_exists('payment_modes')): ?>
                      		<?php $modes = $this->db->select('*')->from('payment_modes')->get()->result(); 
					...
					<tr>
					 ...
					 <td><?= $query[0]['tot']; ?></td>
			 		  <td><div class="btn-group">
						  <?php if($this->session->admin['role'] == 'superadmin') : ?>
