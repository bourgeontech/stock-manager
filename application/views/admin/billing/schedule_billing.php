...
<!--                                 <th style="text-align:right;"><span onclick="addRow()"><i class="fa fa-plus" style="padding: 8px;"></i></span></th> -->
                            ...
                            <tbody id="dataTable1">
                            <tr>
                                <td><select name="diety_id" id="diety_id"  class="sq_form" style="width:100%;">
                                    <option selected="selected" value="0">Please Select</option>
                                        <?php foreach ($diety_list as $diety){  ?>
                                        <option value="<?php echo $diety['id'];?>"><?php echo $diety['name'];?></option>
                                        <?php  } ?>
                                </select></td>
                                <td><input type="text" name="ben_name" id="name_100" class="sq_form" placeholder="Name" value="" required style="width: 3.2cm;" ></td>
...
<!--                                   <select name="pooja_id" id="pooja_100" onchange="change_rate(100)"  onload="change_rate(100)" class="js-example-basic-single sq_form" style="width: 3.2cm;">
                                ...
                                <td><input type="hidden" value="100" id="row_value">
                                    <input id="qlt_100" type="number" min="1" name="qlt" onchange="checkallowedqty(100);calcPoojaVal();" onkeyup="checkallowedqty(100);calcPoojaVal();"  class="sq_form" placeholder="Quatity" value="1" readonly></td>
                                <td><input id="rate_100" type="text" name="rate"  class="sq_form" placeholder="Rate" readonly value=""></td>
        ...
        <!-- <div style="align: center;" class="form_body">
          ...
          <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative">
               <table class="table  srp_table" width="100%">
                                        ...
                                        <tr>
                                         ...
                                         <tr>
                                           ...
                                           <td><input style="border-color: red;" type="text" name="mobile" class="sq_form" placeholder="" required  value=""></td>
               ...
               <div class="col-sm-12 buttons" style="display:none;">
                        ...
                        <button id="saveandprint" type="submit" class="btn btn-success" name="save" value="saveandprint" style="margin:-10px 4px 0 4px;"> Save & Print</button>
          </div>
          </div>
	    </div>
         ...
         function searchPooja(){
              $.ajax({
                   ...
                   success: function( data ) {
                   		 if(data.diety == 8 || data.diety == 2000) {
                         ...
                         $('#diety_id').val(data.diety);
                   		 $('#amount_received').attr('max', data.rate);
                         calcPoojaVal();
                   		 $('#dmyo').focus().select()
                   },
                });
