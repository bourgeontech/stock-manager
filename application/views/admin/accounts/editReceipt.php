       ...
       <div class="row">
	     <div class="col-lg-12 col-md-12 col-sm-12 ">
		  <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
			<div class="row">
              <div class="col-lg-6 col-md-6 col-sm-6 ">
                <h2 class="page_txt"><i class="fa fa-list-ol" aria-hidden="true"></i>&nbsp;&nbsp;Edit Receipt </h2>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-6 ">
        <div class="header">
...
<h5>Last Vocher No: <?= $voucher_no; ?></h5>
		       ...
		       <form action="<?php echo base_url(); ?>index.php/accounts/editReceipt/<?php echo $id; ?>" method="post" onsubmit="return validateForm()" id="myform">
                  ...
                  <tr>
                     <td><input type="text" name="voucher_no[]" id="vou_100" class="sq_form" placeholder="Voucher No" value="<?php echo $receipt->voucher_no; ?>" required></td>
                      ...
                      <?php foreach($ledger as $val){ ?>
                        <option value="<?= $val['led_Id']; ?>" <?php if($receipt->ledger==$val['led_Id']) { echo "selected";} ?>><?= $val['name']; ?></option>
                      <?php } ?>
                     </select>
                    </td>
                    ...
                    <td><input type="text" name="narration[]" id="name_100" class="sq_form" placeholder="Narration" value="<?php echo $receipt->narration; ?>"></td>
