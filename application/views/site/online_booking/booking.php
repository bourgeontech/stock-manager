                  ...
                  <div class="row">
                    <div class="col-lg-8 offset-lg-0">
                      <div class="accordion_d">
                        ...
                        <form action="<?php echo base_url(); ?>index.php/onlinepayment/booking" method="post">
                        <div class="row">
                          <div class="col-sm-12">
                      ...
                      <div class="mybooking cart">
                        ...
                        <div class="cart_details">
                          <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            ...
                            <tr class="g_total">
                              <td>TOTAL</td>
                              <td>Rs <span id="ContentPlaceHolder1_lbltotal2"><?php print_r($this->amount);?></span></td>
                            </tr>
                          </table>
                          <div> <a ID="btn_pay" class="btn_pay" href="<?php echo base_url(); ?>index.php/onlinepayment/review" style="text-align: center;">Review &amp; Pay</a> </div>
                          <div class="text-center"> <a ID="btn_discard" class="btn btn-outline-warning w-100" href="<?php echo base_url(); ?>index.php/onlinepayment/discard" style="text-align: center;">Discard</a> </div>
                        </div>
                      </div>
                    </div>
                  </div>
