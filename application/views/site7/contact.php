  ...
  <div class="container">
      ...
      <div class="row">
         ...
         <div class="col-xl-3 col-lg-3 col-md-4 col-sm-12">
              <div class="speakers">
                  <div class="spk-img">
                      <img class="img-fluid" src="<?php echo base_url(); ?>/assets/site6/images/team_k.jpg" alt="trainer-img" />
          ...
          <tbody>
            <tr>
              ...
              <td><strong> 	Address</strong><br>
                The Manager, Parakkunnathu Temple, Chellur, Kuttippuram, Kerala 679571 </td>
            </tr>
            <tr>
