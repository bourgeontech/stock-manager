 <html>
	...
	<body onload="printcontend('printer')" onafterprint="myFunction()">
		<div id="printer">
            ...
            JOIN billing B on A.bill_id=B.id JOIN diety d ON A.diety_id=d.id WHERE A.date BETWEEN '$from' AND '$to' AND A.diety_id='$diety' AND B.status='1' GROUP BY A.pooja")->result_array();
			?>
			<table border="1" style="border-collapse:collapse;width:100%;margin-bottom:1cm;">
			    <thead>
    				<tr>
...
<script>
window.onfocus = function () { setTimeout(function () { window.location = "<?php echo base_url();?>index.php/admin/admin/bill_summary_bytime" }, 500); }
function myFunction(){
    window.location = "<?php echo base_url();?>index.php/admin/admin/bill_summary_bytime";
}
