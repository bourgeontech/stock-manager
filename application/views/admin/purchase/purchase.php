  <div class="side_right">
    ...
    <div class="page-header">
       ...
       <div class="row">
	     <div class="col-lg-12 col-md-12 col-sm-12 ">		 
	        ...
	        <form action="<?php echo base_url(); ?>index.php/admin/admin/purchase" method="post" id="myform">
               <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12">
      ...
      <div class="form_body">
        ...
        <div class="form-group">
          <div class="row_form">
            ...
            <select name="supplier_id" id="supplier_id" class="sq_form" required>
      ...
      <div class="col-lg-3">
        <div class="form-group">
          <div class="row_form">
            ...
            <select name="mode" id="mode" class="sq_form" required>
            	...
            	<table class="table table-responsive-sm">
            		...
            		<tbody id="dataTable2">
                		<tr>
                			...
                			<td><input type="text" name="price[]" id="price_100" class="sq_form" placeholder="Rate" value="" ></td>
                			<td><input type="hidden" value="100" id="row_value">
                			    <input type="text" min="1" name="qty[]" onchange="totalcalc(100)" onkeyup="totalcalc(100)" id="qty_100" class="sq_form" placeholder="Quatity" value="1"></td>
                			<td><input type="text" name="tax[]" id="tax_100" onchange="totalcalc(100)" onkeyup="totalcalc(100)" class="sq_form" placeholder="Tax" value="0"></td>
                			<td><input type="text" name="sub_tot[]" id="sub_tot_100" onkeypress="return myKeyPress(event)" class="sq_form" placeholder="Sub Total" readonly="readonly"></td>
                  ...
                  <tr>
                	        ...
                	        <th style="text-align:left" ><input type="text" onkeyup="subtotcalc()" name="discount" id="discount" class="sq_form" placeholder="00" value=""></th>
                	        <th></th>
                	    </tr>
                	    <tr>
                	        <th colspan="4" style="text-align:left">Total</th>
                	        <th style="text-align:left;padding:10px 25px" id="tax_total">0</th>
    ...
    function subtotcalc(){
       ...
       var discount= $('#discount').val();
        for (i = 100; i < 1000; i++) {
          if (!isNaN(parseFloat($('#tax_'+i).val()))){
              tax_tot += parseFloat($('#tax_'+i).val());
          }
          if (!isNaN(parseFloat($('#sub_tot_'+i).val()))){
              tot += parseFloat($('#sub_tot_'+i).val());
          }
        }
        var total=tot-discount;
        $('#tax_total').html(tax_tot);
        $('#total').html(total);
    }
    function totalcalc(e){
        var qty=parseFloat($('#qty_'+e).val());
        var tax=parseFloat($('#tax_'+e).val());
        var price=parseFloat($('#price_'+e).val());
...
//     	alert("ok");
    ...
    function addRow12() {
        ...
        var html = '<tr>';
            ...
            html +='<td><input type="text" name="price[]" id="price_'+row_value+'" class="sq_form" placeholder="Rate" value="" ></td>';
