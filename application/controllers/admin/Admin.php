     ...
     public function add_pooja(){
        ...
        if ($this->form_validation->run() === FALSE){
            ...
            $this->load->view('admin/layouts/admin_footer');
             ...
             $config['upload_path'] = 'uploads/forsales/';
    		...
    		$file_name = '/uploads/forsales/' . $data['file_name']; 
...
//     }
	...
	public function add_customer(){
		...
		if ($this->form_validation->run() === FALSE){
            $this->load->view('admin/layouts/admin_header');
            $this->load->view('admin/customer/customer_add',$data);
            $this->load->view('admin/layouts/admin_footer');
        }else{
    ...
    //print "SELECT sum(qlt*rate) as total FROM `billing_dtls` JOIN billing on billing_dtls.bill_id=billing.id WHERE billing.date='$today'";
        ...
        if ($this->form_validation->run() === FALSE){
          ...
          //	print_r($_REQUEST);exit;
            ...
            $query = $this->db->query("SELECT mobile FROM user_dtl WHERE id='$customer_id'");
    	...
    	if($data['discountype']=='Fixed') { 
											...
											{
											$total1=$received_amount/100*$data['discount'];
			  ...
			  
				{
					...
					$this->db->query("INSERT INTO billing(`diety_id`,`date`,`place`,`user_id`,`status`,`mode`,`bill_time`,`counter`,`book_issue_id`, `customer_id`, `appearance`,discount) VALUES ('$diety[0]','$date','---','$user_id', '1','$mode','$bill_time','$counter','$book_id', '$customer_id', '$appearance','$total1')");
				}
				else
				{
...
//         }
    ...
    public function bill_print($id, $reprint=null){
        ...
        $bill_id=$id;
        if ($_SERVER['HTTP_HOST'] == "illathbhadhrakalitemple.com") {
  ...
  else if($_SERVER['HTTP_HOST'] == "nkavu.templesoftware.in"){
             $counter = $this->session->userdata("counter");
             if($counter == ''){
                 $this->load->view('admin/billing/bill_print_nhangattiri_new',$data);
             }
    ...
    else if($_SERVER['HTTP_HOST'] == "eroorgurumaheswaram.com"){
             $counter = $this->session->userdata("counter");
             if($counter == ''){
                 $this->load->view('admin/billing/bill_print_nhangattiri_new',$data);
             }
     ...
     else if($_SERVER['HTTP_HOST'] == "chempallilvalyachankavu.in"){
             $counter = $this->session->userdata("counter");
             if($counter == ''){
                 $this->load->view('admin/billing/bill_print_nhangattiri',$data);
             }
...
else if($_SERVER['HTTP_HOST'] == "vkavu.templesoftware.in"){
             $counter = $this->session->userdata("counter");
             if($counter == ''){
                 $this->load->view('admin/billing/bill_print_nhangattiri',$data);
             }
    ...
    else if($_SERVER['HTTP_HOST'] == "test.templesoftware.in"){
             $counter = $this->session->userdata("counter");
             if($counter == ''){
                 $this->load->view('admin/billing/bill_print_nhangattiri_new',$data);
             }
     ...
     else if($_SERVER['HTTP_HOST'] == "sreevyramahakalikavukshethramkarad.in"){
             $counter = $this->session->userdata("counter");
             if($counter == ''){
                 $this->load->view('admin/billing/bill_print_nhangattiri',$data);
             }
 ...
 else if($_SERVER['HTTP_HOST'] == "eswaramangalam.templesoftware.in"){
             $counter = $this->session->userdata("counter");
             if($counter == ''){
                 $this->load->view('admin/billing/bill_print_nhangattiri',$data);
             }
     ...
     else if($_SERVER['HTTP_HOST'] == "balusserykotta.templesoftware.in"){
             $counter = $this->session->userdata("counter");
             if($counter == ''){
                 $this->load->view('admin/billing/bill_print_nhangattiri',$data);
             }
     ...
     else if($_SERVER['HTTP_HOST'] == "kalpathy.templesoftware.in"){
             $counter = $this->session->userdata("counter");
             if($counter == ''){
                 $this->load->view('admin/billing/bill_print_nhangattiri',$data);
             }
     ...
     else if($_SERVER['HTTP_HOST'] == "sreevadakurumbakavu.com"){
             $counter = $this->session->userdata("counter");
             if($counter == ''){
                 $this->load->view('admin/billing/bill_print_nhangattiri',$data);
             }
     ...
     else if($_SERVER['HTTP_HOST'] == "anayedath.templesoftware.in"){
             $counter = $this->session->userdata("counter");
             if($counter == ''){
                 $this->load->view('admin/billing/bill_print_nhangattiri',$data);
             }
...
//              }
       ...
       // 
    ...
    else if($_SERVER['HTTP_HOST'] == "puthookkavu.templesoftware.in"){
             $counter = $this->session->userdata("counter");
             if($counter == ''){
                 $this->load->view('admin/billing/bill_print_nhangattiri',$data);
             }
             ...
             // echo $printer;exit;
                if($printer == 2){
                    $this->load->view('admin/billing/bill_print_nhangattiri_no_header_malayalam2',$data);
                }
                else if($printer == 3){ 
                   $this->load->view('admin/billing/receiptprint',$data);
                }
...
//              }
    ...
    else if($_SERVER['HTTP_HOST'] == "ayt.kaladyshankaramadomts.org"||$_SERVER['HTTP_HOST'] == "ayb.kaladyshankaramadomts.org"){
//              $counter = $this->session->userdata("counter");
//              if($counter == ''){
//                  $this->load->view('admin/billing/bill_print_tali2',$data);
//              }
...
//              }
    ...
    public function dmbill_print($id){
        ...
        if ($_SERVER['HTTP_HOST'] == "amruthamangalam.templesoftware.in") {
            $this->load->view('admin/billing/dmprint_amruthamangalam',$data);
         }
    	 else if ($_SERVER['HTTP_HOST'] == "alathiyoor.templesoftware.in") {
            $this->load->view('admin/billing/bill_print_nhangattiri_date_split_pooja_cat_preprint_alathiyoor',$data);
   ...
   $this->load->view('admin/billing/receipt_print',$data);
     ...
     $this->load->view('admin/billing/receiptprint_dynamic',$data); 
    }
    }
...
public function bill_report_twodate(){
    ...
    public function bill_summary($ids=null){
        ...
        elseif($this->input->post('printdatewise')=="printdatewise"){
                $data['bill_list']=$this->general_model->getbillsummurydatewise($from,$to,$diety,$type,$ampm);
				$this->load->view('admin/billing/summary_print_datewise',$data);
            }
 ...
 **/
    public function detail_view($ids=null){
        ...
        $view_print = 'admin/billing/detail_view_print_cat';
        } else {
        	$view_page = 'admin/billing/detail_view';
        $view_print='admin/billing/detail_view_print';
        }
        ...
        if ($this->form_validation->run() === FALSE){
        	...
        	if($this->db->field_exists('categorized_daily_pooja_summary', 'site_settings') && $settings->categorized_daily_pooja_summary == 1) {
            	...
            	$data['bill_listdeleted']=$this->general_model->getdlbill($from,$to);
            } else {
            	$data['bill_list']=$this->general_model->getBillList($from,$to,$diety,$type);
            	$data['bill_listdeleted']=$this->general_model->getdlbill($from,$to);
            }
            ...
            if($this->input->post('serch')=="serch"){
                ...
                $data['temple_list']=$this->general_model->gettemples();
                $this->load->view($view_print,$data);
            }
        elseif($this->input->post('printdatewise')=="printdatewise"){
				$data['bill_list']=$this->general_model->getBillListDatewise($from,$to,$diety,$type);
                $data['temple_list']=$this->general_model->gettemples();
				$view_print='admin/billing/detail_view_print_datewise';
                $this->load->view($view_print,$data);
            }
        }
    }
...
public function counter_wise_pooja(){
	...
	public function counter_wise(){
        ...
        $data['start_bill']=$this->general_model->start_bill(date("Y-m-d"),date("Y-m-d"));
        $data['end_bill']=$this->general_model->end_bill(date("Y-m-d"),date("Y-m-d"));
   ...
   //print_r($data);exit;
          ...
          $data['start_bill']=$this->general_model->start_bill($datef,$datet); 
    
     $data['end_bill']=$this->general_model->end_bill($datef,$datet);
          //  print_r($data);exit;
            $data['datef']=$datef;
            $data['datet']=$datet;
...
{ 
        ...
        $bill = $this->db->where('id', $id)->get('billing')->row();
	$created_time = strtotime($bill->created_at);
    $now_time     = time();
	...
	if ($bill->user_id != $this->loggedIn['id']) {
        ...
        //print "UPDATE billing SET `mode`='$mode' WHERE id='$id'";exit;
           ...
           // print "UPDATE billing_dtls SET `name`='$nama',`star`='$ster',`date`='$data',`time`='$time' WHERE id='$id1'";exit;
              if($this->db->table_exists('memberships')) {
				$membershipid = $this->db->where('bill_id', $id)->get('membership_transactions')->row();
			$membership_id=$membershipid->membership_id;
              if(@$membership_id!='')
              		{
            $this->db->query("UPDATE memberships SET `name`='$nama' WHERE id='$membership_id'");
              		}
...
public function getPoojaByCodeNameDietyforbilling(){
        ...
        $keyword=$this->input->post('search');
           ...
           $this->db->select('diety_pooja.*,pooja.code as code,pooja.name as pooja,pooja.name_mal as pooja_mal,pooja.rate as pooja_rt,diety.name_mal as diety_mal, diety.name as diety,pooja.rowcount');
           $this->db->from('diety_pooja');
           $this->db->join('pooja','pooja.id = diety_pooja.pooja_id');
           $this->db->join('diety','diety.id = diety_pooja.temple_id');
		   $this->db->like('pooja.name', $keyword,'after');
        ...
        if ($query->num_rows() > 0) {
            ...
            $response = array();
            foreach($poojas as $pooja){
               $response[] = array("id"=>$pooja['pooja_id'],"rowcount"=>$pooja['rowcount'], "value"=>$pooja['pooja_mal'].' ( '.$pooja['diety_mal'].' ) ~ '.$pooja['code'],"label"=>$pooja['code'].' | '.$pooja['pooja'].' - '.$pooja['pooja_mal'].' ( '.$pooja['diety'].' ) ');
            }
            echo json_encode($response);
        }
...
/*
$suggestions = $this->fetchSuggestions($text, $curlSession);
