            ...
            <div class="container">
                <div class="menu-bg-4 white-bg">
                    <div class="row align-items-center">
                        ...
                        <div class="col-xl-10 col-lg-12 col-md-6 col-6">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="#" >About</a>
                                            <ul class="sub-menu">
                                            	...
                                            	<li><a href="<?php echo base_url(); ?>index.php/welcome/trustee_board">Trust Board</a></li>
                                        ...
                                        <li><a href="#">Sevas/Ritual</a>
                                            <ul class="sub-menu">
                                            	...
                                            	<li><a href="<?php echo base_url(); ?>index.php/welcome/gowpooja"> GOW SEVA </a></li>
                    ...
                    <?php  if($site_settings['online']=='1'){?>  
                        <div class="col-xl-1 col-lg-2 col-md-4 col-6 d-flex flex-row">
                           <div class="logo" >
                            ...
                            <a class="s-btn" target="_blank" href="https://donate.kaladyshankaramadomts.org/">Donation</a>
                            </div>
                        </div>
                    <?php } ?>
