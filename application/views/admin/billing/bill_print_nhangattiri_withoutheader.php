...
<!--                     		<?php if($pageBreak1 == 1): ?>
  ...
  word-break: break-word;width:150px;"><?php echo strtoupper($val['name']);?></td>
                                <td><?php echo $val['star_eng'];?></td>
                                <td style="white-space: normal;
  word-break: break-word;width:150px;"><?php echo $val['pooja_nm']; if ($date!=$today){echo "(".date('d-m-Y',strtotime($date)).")";}?></td>
