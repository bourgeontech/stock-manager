    ...
    <div id="printer" class="page-break">
        <table class="header">
            <tr>
                ...
                <td class="td_second" style="width: 295px  !important; max-width: 295px  !important;"><?php print_r($detail[0]['deity']);?></td>
                <td class="td_third" style="width: 60px  !important;"></td>
                <td class="td_fourth"><?php print_r(date('d-m-Y',strtotime($detail[0]['bill_date'])));?></td>
            </tr>
            <tr>
                <td class="td_first" style="width: 77px  !important;"></td>
                <td class="td_second" style="width: 295px  !important; max-width: 295px  !important;"><?php print_r($detail[0]['pooja']);?></td>
                <td class="td_third" style="width: 60px  !important;"></td>
                <td class="td_fourth"><?php print_r($detail[0]['bill_no']);?></td>
            </tr>
        </table>
        <table class="body">
            ...
            <tr style="height:<?php print_r($height); ?>">
                <td class="td_first"><?php echo strtoupper($val['name']);?> - <?php echo $val['star'];?></td>
                <td class="td_second"><?php echo $val['qty'];?></td>
                <td class="td_third"><?php echo $val['rate'];?></td>
            ...
            <tr class="total">
                ...
                <td class="td_fourth"><?php echo $sub_total;?></td>
            </tr>
            
            <tr class="date">
                <td colspan="4" style="padding-left: 200.18110236px  !important;"><?php print_r(date('d-m-Y',strtotime($detail[0]['pooja_date']))); ?></td>
            </tr>
