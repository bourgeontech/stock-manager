                     ...
                     $amt=$val['amount'];
                      ...
                      $amount=$val['amount'];
				        ...
				        <tr style="text-align:center;">
				            ...
				            <td style="text-align:left;"><?php echo $pooja_rt;?></td>
                        	<td >&nbsp;</td>
				            <td style="text-align:right;float:right;margin-right:0px;"><?php echo $amount;?></td>
				        </tr>
				    <?php 
				        $i++;
                   $j=$i;
				    }?>
                <?php if($j<5) {$k=11-$j;} for ($l=0;$l<$k;$l++){ ?>  <tr>
				        <th>&nbsp;</th>
				   ...
				   <tr>
				        <th>&nbsp;</th>
				        <th colspan="7" style="text-align:left;font-size:20px;font-weight:bold;">Total</th>
				        <th style="text-align:right;font-size:20px;font-weight:bold;"><?php echo $total;?></th>
				    </tr>
				    <!--<tr>
