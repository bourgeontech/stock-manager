    ...
    <div class="page-header">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 ">
          <ul class="btn_ul" style="float:right;">
            <li> <a href="<?php echo base_url();?>index.php/cms/addBanner" class="btn btn-primary">Add New&nbsp;&nbsp;<i class="fa fa-plus" aria-hidden="true"></i></a> </li>
          </ul>
        </div>
    </div>
       <div class="row">
				...
				<table class="table table-bordered table-hover text-nowrap" width="100%">
				  ...
				  <tbody>
					<tr>
                      ...
                      <img src="../../uploads/banner/<?PHP echo $image; ?>" width="50"/>
                      <?php } ?></td>
