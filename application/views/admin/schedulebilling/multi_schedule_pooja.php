                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="row_form">
                                            ...
                                            <input class="sq_form name" placeholder=" Name" id="name1" name="name[]"  type="text" >
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="row_form">
                                            ...
                                            <input class="sq_form name_locale" placeholder=" Name Locale" id="name_locale1" name="name_locale[]"  type="text" >
                                    ...
                                    <div class="form-group">
                                      <div class="row_form">
                                        <div class="div_label">
                                      	...
                                      	<select name="star_id[]" id="star_101" class=" sq_form firststar" required style="width: 3.2cm;">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <div class="row_form">
                                            ...
                                            <input class="sq_form" placeholder=" Quantity" id="qty1" name="qty[]"  type="number" min="1" value="1" >
...
//             	});
					...
					html='<div class="col-md-4"><div class="form-group">';
                                        html+='<div class="row_form">';
                                             html+='<div class="div_label">';
                                                 html+='<label class="text_label">Name <span class="red">*</span> </label>';
                                             html+='</div>';
                                             html+='<input class="sq_form name" placeholder=" Name" id="name2" name="name[]"  type="text" >';
                                            html+='<input id="billno" name="billno" value="<?php echo $last_id;?>" type="hidden" >';
                                			<?php echo form_error('name', '<div class="error">', '</div>'); ?>
                                        html+='</div>';
                                    html+='</div>';
                                html+='</div> <div class="col-md-4">';
                                    html+='<div class="form-group">';
                                       html+=' <div class="row_form">';
                                            html+='<div class="div_label">';
                                                html+='<label class="text_label">Name Locale<span class="red">*</span> </label>';
                                            html+='</div>';
                                            html+='<input class="sq_form name_locale" placeholder=" Name Locale" id="name_locale2" name="name_locale[]"  type="text" >';
                                			<?php echo form_error('name_locale', '<div class="error">', '</div>'); ?>
                                        html+='</div>';
                                    html+='</div>';
                                html+='</div>';
                                html+='<div class="col-md-4">';
                                    html+='<div class="form-group">';
                                      html+='<div class="row_form">';
                                        html+='<div class="div_label">';
                                          html+='<label class="text_label">Birth Star <span class="red">*</span> </label>';
                                        html+='</div>';
                                      
                                      	html+='<select name="star_id[]" id="star_101" class=" sq_form firststar" required style="width: 3.2cm;">';
                                
                                    html+='<option value="">Select Star</option>';
                                    <?php foreach($star_list as $val){ ?>  
                                        html+='<option data-name="<?= $val['name_eng']; ?>" value="<?= $val['id']; ?>"><?= $val['name_eng']." - ".$val['name_mal']; ?></option>';
                                    <?php } ?>
                                html+='</select>';
                                        <?php echo form_error('star_id', '<div class="error">', '</div>'); ?>
                                      html+='</div>';
                                ...
                                html+='<div class="col-md-4">';
                                    html+='<div class="form-group">';
                                        html+='<div class="row_form">';
                                            html+='<div class="div_label">';
                                                html+='<label class="text_label">Quantity <span class="red">*</span> </label>';
                                            html+='</div>';
                                            html+='<input class="sq_form" placeholder=" Quantity" id="qty2" name="qty[]"  type="number" min="0" value="0" readonly >';
                                			<?php echo form_error('qty', '<div class="error">', '</div>'); ?>
                                        html+='</div>';
                                    html+='</div>';
                                html+='</div>';
   ...
   $(document).on('keydown', (e) => {
    if (e.keyCode == 9 || e.keyCode == 13) { // TAB or ENTER
        let $focused = $(".name:focus");   // check if any .name input is focused
        if ($focused.length > 0) {
            e.preventDefault();
            ...
            $.ajax({
                ...
                type: 'post',
                dataType: "json",
                data: { search: $focused.val() },
                success: function(data) {
                    console.log(data);
                    // find the matching .name_locale in the same row
                    $focused.closest('.row').find('.name_locale').val(data.name);
                }
            });

            // move focus → star dropdown in the same row (if needed)
            $focused.closest('.row').find(".search_star").focus();
        }
    }
});
