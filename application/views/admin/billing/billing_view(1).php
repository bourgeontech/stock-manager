		  ...
		  <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
			<div class="row">
             ...
             <?php
              ...
              $query4 = $this->db->query("SELECT mookola_settings FROM  site_settings where 1 limit 0,1");
				  ...
				  <thead>
					...
					<?php 
	                    ...
	                    foreach($bill_list as $val){
	                        ...
	                        $this->db->select('billing.*,SUM(billing_dtls.amount) as tot,sum(billing_dtls.postal_amt) as postal');
...
<i class="fa fa-pencil"></i></a>-->
					...
					<tfoot>
                        ...
                        <th><?php echo $post;?></th>
                        <th><?php echo $rtot;?></th>
                        <th><?php echo ($total+$post)-($rtot);?></th>
							<th></th>
						</tr>
					</tfoot>	
				</table>
