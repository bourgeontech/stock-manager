				  ...
				  <tbody id="myTable">
                    ...
                    <td><?= $val['rate']; ?></td>
					  <td><div class="btn-group">
						<?php if ($role=="superadmin" || $role=="admin"){?>  <a href="<?php echo base_url();?>index.php/admin/admin/edit_pooja/<?= $val['id']; ?>" class="btn btn-outline-info" style="padding:6px;" title="Edit"> <i class="fa fa-edit"></i></a> 
