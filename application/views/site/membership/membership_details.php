...
<body>
    <nav>
    	...
    	<?php if ($membership): ?>
        <a href="<?php echo base_url(); ?>index.php/membership/membership_details" class="active">Membership Details</a>
    ...
    <h1 id="membership-details" class="mt-5">Membership Details</h1>
    <?php if ($membership): ?>
        <div class="card">
