...
-->
          ...
          <tr>
            ...
            <td><strong style="margin-bottom: 5px;display: block;text-transform: uppercase;"><?= $val['name']; ?></strong></td>
          ...
          <td style="text-align: right;">
            ...
            if($type==2){
               ...
               ?>
               <span><i class="fa fa-inr" aria-hidden="true"></i> <?=  (number_format($val['amount'], 2, '.', '')); ?></span>
             <?php } ?></td>
  <td style="text-align: right;">
              <?php 
              if($type==1){
    ...
    <tfoot>
     ...
     <tr>
      <th colspan="2" style="text-align: right;color:gray;">Opening /Closing Balance</th>
       <td style="text-align: right;"><i class="fa fa-inr" aria-hidden="true"></i> <?php print $total_opening_cash; ?>
       </td><i class="fa fa-inr" aria-hidden="true"></i> <td colspan="1" style="text-align: right;"><i class="fa fa-inr" aria-hidden="true"></i><?php print $current_month_closing_cash;?>
      </td>
