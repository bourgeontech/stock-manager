	...
	<body onload="printcontend('printer')" onafterprint="myFunction()">
		<div id="printer">
		   ...
		   // $diety_id=$this->db->query("SELECT id From diety")->get()->result_array();
		    ...
		    ?>
			<table border="1" style="border-collapse:collapse;width:88%;margin-bottom:1cm;font-size:14px;">
			    <thead>
    				<tr>
            ...
            ?><?php echo ++$key;?></td>
				 ...
				 <?php } ?>
                	...
                	<?php endif; ?>
				    <tr>
				        <th colspan="8" >For Online Pooja booking please visit <a href="<?php print_r($temple_list[0]['website']);?>"><?php print_r($temple_list[0]['website']);?></a>   - </th>
				    </tr>
            	</tbody>
			</table>
			<?php }?>
