...
class Custombooking extends CI_Controller {
	 ...
	 * 	Add Custom 
	 ***/
	public function update_temp_data() {
    	// Validation
       ...
       // print $formData;exit;
        	$this->db->insert('custom_booking_details', $formData);
	...
	public function review() {
    	...
    	if ($this->form_validation->run() === FALSE) {
            ...
            $this->db->query("INSERT INTO billing(`diety_id`,`date`,`place`,`amount`,`customer_id`,`count`,`total`,`status`,`recv_amt`,`counter`,`bill_time`, `bill_type`, `created_at`, `user_id`) VALUES ('$deity','$today','---','$total','$customer_id','$count','$total', '1','$total','$counter','0000-00-00 00:00:00','N', '$now', '$user_id')");
