              ...
              <div class="row justify-content-center">
                ...
                <div class="col-lg-10 offset-lg-0">
                  <div class="accordion_d">
                    <div>E-Kanikka</div>
                      <div class="booking_outer text-center">
                          <div class="row">
                            <div class="col-sm-12">
                            	<table class="table table-hover" width="100%" border="1">
                                	...
                                	<tbody>
                                	    ...
                                	    <tr>
                                                <td><?php echo "1";?></td>
                                                <td><?php echo $bill_list['name'];?></td>
                                        		<td><?= $user_list[0]['mobile']; ?></td>
                                        		<td><?= $user_list[0]['house']." ".$user_list[0]['street']." ".$user_list[0]['post']." ".$user_list[0]['district']." ".$user_list[0]['state']." ".$user_list[0]['pincode']." ".$user_list[0]['email'] ?></td>
                                                <td style="text-align:right"><?php echo $amount/100;?></td>
                                            </tr>
                      	  ...
                      	  <hr />
                      	  <a href="<?php echo base_url(); ?>index.php/donation/booking"><input type="button" value="Back" class="btn btn-warning cart_btn btn-lg"></a>
                      	  <input type="button" name="date" value="Pay Amount" id="make_payment_btn" data-gateway="<?= $payment_gateway ?>" class="btn btn-lg btn-success ml-auto">
                      </div>
                  </div>
                </div>
<!--                 	<div class="col-lg-4">
...
<script>
    ...
    document.getElementById('make_payment_btn').onclick = function (e) {
        ...
        if(gateway == 1) {
            ...
            formData.append('payeramount', '<?php echo $total; ?>');
