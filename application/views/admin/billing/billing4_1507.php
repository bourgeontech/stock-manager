      ...
      <div class="form_body">
        <div class="row">  
		   <div class="col-lg-12">
                  ...
                  <div class="row_form">
            		...
            		<tbody id="dataTable2">
                		<tr>
                        	...
                        	<td><select name="pooja[]" id="pooja_100" onchange="change_rate(100)" onload="change_rate(100)" class="sq_form js-example-basic-single" required style="width: 10cm;">
            ...
            <div class="col-md-12">
                <div class="form-group">
                  <button type="submit" onclick="formsubmit('save');" class="btn submit  pull-right" name="save" id="100" value="print" style="margin:7px 4px;background-color:#90EE90;" onfocus="test();"> Save &amp; Print </button>
...
var pooja_fetch_url = "<?php echo base_url(); ?>index.php/admin/getPoojaTimeByName";
    ...
    function addRow() {
        ...
        var html = '<tr>';
			...
			<?php } ?>
            html +='</select></td>';
    		html +='<td><select name="pooja[]" id="pooja_'+row_value+'" onchange="change_rate('+row_value+')" class="js-example-basic-single sq_form" required style="width: 10cm;"><option value="">Select Pooja</option>';
            html +='</select></td>';
            ...
            html +='<td><select name="time[]" id="time_'+row_value+'" class="sq_form" onkeypress="return myKeyPress(event)" required style="width: 1.6cm;"><option value="">Time</option>';
      ...
      var poojacodee='<?php echo $site[0]['poojacode']?>';
        ...
        var html = '<tr>';
    		...
    		html +='<td><input type="number" name="qlt[]" id="qlt_'+row_value+'" class="sq_form" placeholder="Quantity" value="0"></td>';
