    ...
    <div class="row">
	        ...
	        <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
               <div class="row">
                  <div class="col-lg-12 col-md-12 col-sm-12 ">
                    <h2 class="page_txt"><i class="fa fa-plus-square-o" aria-hidden="true"></i>&nbsp;&nbsp;Issue Book </h2>
                  </div>
			   </div>
		       <form action="<?php echo base_url(); ?>index.php/admin/admin/book_issue" method="post" >
      ...
      <div class="col-lg-12">
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder="Book Issue Serial Number" id="issue_id" name="issue_id" onchange="checkissueid()" type="text" >
          ...
          <div class="row_form">
            ...
            <select class="sq_form" id="book_id" name="book_id" onchange="changebook()" require>
              ...
              <?php foreach($book_list as $book){?>
                <option value="<?php echo $book['id'];?>"><?php echo $book['book_no'];?></option>
              <?php }?>
            </select>
        ...
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder=" Sl No From" id="from_sl" name="from_sl" min="1" onkeyup="changeno_bills()" onchange="changeno_bills()" type="number" >
        ...
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder=" Sl No To" id="to_sl" name="to_sl" onkeyup="changeno_bills()" onchange="changeno_bills()" min="1" type="number" >
        ...
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder="No Of Bills" id="no_bills" name="no_bills" onfocus="changeno_bills()" onclick="changeno_bills()" min="1" type="number" readonly>
        ...
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" id="issue_date" name="issue_date" type="date" value="<?php echo date('Y-m-d');?>">
      ...
      <div class="col-lg-12" hidden>
        <div class="form-group">
          <div class="row_form">
            <div class="div_label">
              <label class="text_label">Book Status </label>
            </div>
            <input class="sq_form" id="book_status" name="book_status" value="Issued" type="hidden" >
			<?php echo form_error('book_status', '<div class="error">', '</div>'); ?>
          </div>
        </div>
      </div>
           <div class="col-sm-12">
...
<script>
  ...
  function checkissueid(){
    ...
    var url = "<?php echo base_url(); ?>index.php/admin/admin/checkduplicateissue";
    $.ajax({
        type: "GET",
        url: url,
