			...
			<table border="1" style="border-collapse:collapse;width:100%; ">
			    <thead>
                    ...
                    <?php date_default_timezone_set( 'Asia/Calcutta' );
                       ...
                       ?>
    					<th colspan="8"><label style="float:left;">PAY<?php print_r($paymentData[0]['f_year']) ?> - <?php print_r($paymentData[0]['voucher_no']);?></label>
					        <label style="float:center;">PAYMENT DETAILS</label>
    					    <label style="float:right;font-size:bold;">Date : <?php print date('d-m-Y',strtotime($paymentData['0']['payment_date']))?></label>
    				    </th>
    				</tr>
    				<tr>
