...
<div class="side_right">
    ...
    <div class="page-header">
        <div class="col-lg-9 col-md-9 col-sm-12 ">
          <h4 class="page_txt">Pooja Availability</h4>
        </div>
    </div>
       ...
       <div class="row">
	     <div class="col-lg-12 col-md-12 col-sm-12 ">		 
	        ...
	        <form action="<?php echo base_url(); ?>index.php/admin/billing/assign_allowed_quantity" method="post" onsubmit="return validateForm()" class="billingForm" id="myform">
      ...
      <div class="form_body">
        <div class="row">  
		   <div class="col-lg-12">
              <div class="form-group">
                  <div class="row_form">
            		...
            		<tbody id="dataTable2">
                		<tr>
                			<td>
                            	<select name="temple[]" id="temple_100" onchange="changepooja(100)" class=" sq_form deity w-100"  required style="width: 3.2cm;">
                            ...
                            <select name="pooja[]" id="pooja_100" onchange="change_rate(100)" onload="change_rate(100)" class="sq_form js-example-basic-single pooja_id" required style="width: 10cm;">
                                	<option value="">Select Pooja</option>
                    			</select>
                			</td>
                			<td><input type="date" name="date[]" id="date_100" class="sq_form datefield w-100" placeholder="Date" value="<?php echo date('Y-m-d');?>"  onchange="checkallowedqty(100);" onclick="checkallowedqty(100);"  style="max-width: 4.2cm;"></td>
                		    <td><input type="hidden" value="100" id="row_value">
                			    <input type="number" min="1" name="count[]" onchange="change_rate(100),checkallowedqty(100)" onkeyup="change_rate(100),checkallowedqty(100)" id="qlt_100" class="sq_form qty w-100" placeholder="Quatity" value="1"></td>
            ...
            <div class="col-md-12">
                <div class="form-group">
                  <button type="submit" onclick="formsubmit('save');" class="btn submit pull-right" name="save" id="100" value="print" style="margin:7px 4px;background-color:#90EE90;" onfocus="test();"> Save </button>
...
var availabilityChecked = false;
    ...
    function change_rate(e){
    	var $row = $('#qlt_'+e).closest('tr'); // Get the closest row element
  ...
  // alert("o");
    ...
    function changepooja(e,pooja_selected=null){
        ...
        var url = '<?php echo base_url();?>index.php/admin/pooja/getPoojaByDeity';
    	$.ajax({
            type: "POST",
            url: url,
            data: {'deity_id': diety},
            ...
            success: function (data) {
                ...
                $.each(data, function (i, obj)
                {
                	...
                	html +='<option value="'+obj.id+'">'+pooja+' - '+obj.pooja_mal+' ('+obj.code+')</option>';
                });
    ...
    function addRow() {
        ...
        var html = '<tr>';
            ...
            html +='</select></td>';
            html +='<td><input type="date" name="date[]" id="date_'+row_value+'" class="sq_form datefield" placeholder="Date" value="'+bill_date+'" onchange="checkallowedqty('+row_value+');" onclick="checkallowedqty('+row_value+');"   style="max-width: 4.2cm;"></td>';        
            html +='<td><input type="number" min="1" name="count[]" id="qlt_'+row_value+'" onchange="change_rate('+row_value+'),checkallowedqty('+row_value+')"  onkeyup="change_rate('+row_value+'),checkallowedqty('+row_value+')" class="sq_form qty" placeholder="Quatity" value="1"></td>';
    ...
    function addSecondRow(data) {
      var poojacodee='<?php echo $site[0]['poojacode']?>';
        ...
        var html = '<tr>';
            ...
            html +='<td><input type="text" name="rate[]" id="rate_'+row_value+'" class="sq_form" placeholder="Rate" readonly value="0"></td>';
            html +='<td><input type="text" name="amt[]" id="amt_'+row_value+'" onkeyup="totalcalc()" class="sq_form" placeholder="Amount" readonly value="0"></td>';
