    ...
    <div class="page-header">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 ">
          <ul class="btn_ul" style="float:right;">
            <li> <a href="<?php echo base_url();?>index.php/accounts/addReceipt" class="btn btn-primary">Add New&nbsp;&nbsp;<i class="fa fa-plus" aria-hidden="true"></i></a> </li>
          </ul>
        </div>
    </div>
       <div class="row">
	     <div class="col-lg-12 col-md-12 col-sm-12 ">
		  <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
			<div class="row">
              <div class="col-lg-6 col-md-6 col-sm-6 ">
                <h2 class="page_txt"><i class="fa fa-list-ol" aria-hidden="true"></i>&nbsp;&nbsp;View Receipt </h2>
              </div>
              <div class="col-lg-6 col-md-6 col-sm-6 ">
        <div class="header">
...
<div class="row">
			  ...
			  <!-- <div class="col-lg-12 col-md-12 col-sm-12 ">
                  <h2 class="page_txt"><i class="fa fa-filter" aria-hidden="true"></i>&nbsp;&nbsp;Search By Date  </h2>
			  </div>    -->
			  <div class="col-lg-4 col-md-4 col-sm-4 ">
                  <form action="<?php echo base_url();?>index.php/accounts/searchReceipt" method="post">
                  <div class="input-group mb-3">
<input type="date" class="form-control" name="search" value="<?php if(@$datefrom!='') { echo $datefrom; } ?>" required placeholder="Search By Day From" aria-label="Search Attendance By Day" aria-describedby="basic-addon2">
<input type="date" class="form-control" name="searchto" value="<?php if(@$dateto!='') { echo $dateto; } ?>" required placeholder="Search By Day To" aria-label="Search Attendance By Day" aria-describedby="basic-addon2">
			  ...
			  <div class="col-lg-2 col-md-2 col-sm-2 ">
                <!-- <a href="<?php echo base_url();?>index.php/accounts/viewReceipt" class="btn btn btn-outline-secondary" style="font-size: 18px;"><i class="fa fa-list-ul" aria-hidden="true"></i> View All</a> -->
               
                <ul class="btn_ul">
            <li> <a href="<?php echo base_url();?>index.php/accounts/viewReceipt/all" class="btn btn btn-outline-secondary">View All&nbsp;&nbsp;<i class="fa fa-list-ul" aria-hidden="true"></i></a> </li>
          </ul>
              </div>
	       ...
	       <div class="table-responsive">
            ...
            <td><span style="text-transform: capitalize;font-size: 12px;"><?= $row->name; ?></span></td>
              ...
              <a href="<?php echo base_url(); ?>index.php/accounts/printReceipt/<?= $val['pay_Id']; ?>" class="btn btn-outline-info" style="padding:6px;" title="Print"> <i class="fa fa-print"></i></a> 
                          &nbsp;&nbsp;&nbsp;&nbsp;<?php if ($role=="superadmin"|| $role=="admin"){?><a href="<?php echo base_url(); ?>index.php/accounts/editReceipt/<?= $val['pay_Id']; ?>"  
							 class="btn btn-outline-info" style="padding:6px;" title="Edit"><i class="fa fa-edit"></i></a> <?php } ?>&nbsp;&nbsp;&nbsp;&nbsp;
						    <?php if ($role=="superadmin"|| $role=="admin"){?><a href="<?php echo base_url(); ?>index.php/accounts/deleteReceipt/<?= $val['pay_Id']; ?>"  onclick="return confirm('Are you sure you want to delete?')"
