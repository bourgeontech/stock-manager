	          ...
	          <div class="table-responsive">
                  ...
                  <tbody>
					...
					<tr style="background-color:<?= $clr; ?>">
					   ...
					   <td style="text-align:right">
                          <div class="btn-group">						  
                             <a href="<?= base_url('index.php/admin/report/schedule_bill_details_print/'.$sp['id']); ?>" class="btn btn-outline-primary" style="padding:6px;" title="Details"> <i class="fa fa-print"></i></a> 
						  </div>
                       </td>
					</tr>
                    <?php } } else { ?>
                ...
                <?php 
                  ...
                  $completed = $this->db->query($sql2)->result_array();
                   ...
                   $billsamount = $this->db->query($sql4)->row()->amt;
                   $postal = $totalamount - $billsamount;
                   $postperpooja = $postal / count($bills);
                ...
                ?>
                    ...
                    <tr>
                       ...
                       <td><?php echo count($bills) - count($completed); ?></td>
                    <tr>
                    <tr>
