                    ...
                    if(!empty($bill_dtls)){
                		...
                		<tr>
                			...
                			<td><input type="hidden" value="<?= $i;?>" id="row_value">
                			    <input type="number" min="1" name="qlt[]" onchange="change_rate('<?= $i;?>'),checkallowedqty('<?= $i;?>')" onkeyup="change_rate('<?= $i;?>'),checkallowedqty('<?= $i;?>')" id="qlt_<?= $i;?>" class="sq_form" placeholder="Quatity" value="<?php echo $dtls['qlt'];?>"></td>
                			...
                			<td><input type="date" name="date1[]" id="date_<?= $i;?>" class="sq_form datefield" placeholder="Date" value="<?php echo $dtls['date'];?>"  onchange="checkallowedqty('<?= $i;?>');" onclick="checkallowedqty('<?= $i;?>');"  style="max-width: 4.2cm;"></td>
