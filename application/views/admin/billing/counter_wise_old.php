	          ...
	          <div class="table-responsive" id="printer" onafterprint="myFunction()">
				<table class="table table-bordered table-hover text-nowrap" width="100%">
                  ...
                  $gqrtot=0;
                    ...
                    $this->db->select('admin.name,admin.role,SUM(billing_dtls.amount) as tot_booking,counter.name as countername,billing.mode as mode,counter');
                    $this->db->from('admin');
                    ...
                    }else { $cond="and billing.date ='$today' AND billing.deleted='0'";}
                ...
                //    print "select sum(total) as total from billing where counter='$counter' and mode=1 $cond ";
                    ...
                    $totalcash+=$cashtot;
                    $totalcre=$collection->totalcre;
                    
                   $counter=$val['counter'];
                   $query2=  $this->db->query("select sum(billing_dtls.amount) as total, sum(billing_dtls.postal_amt) as postal_amt from billing_dtls join billing  on billing_dtls.bill_id=billing.id 
                   where  billing.counter= $counter and billing.mode=6 $cond");
                    ...
                    $totalqr+=$qrtot;
                     ...
                     $query5=  $this->db->query("select sum(billing_dtls.amount) as total, sum(billing_dtls.postal_amt) as postal_amt from billing_dtls join billing  on billing_dtls.bill_id=billing.id 
                   where  billing.counter= $counter and billing.mode=5 $cond");
                    ...
                    $totalneft+=$nefttot;
                       ...
                       $query3=  $this->db->query("select sum(billing_dtls.amount) as total, sum(billing_dtls.postal_amt) as postal_amt from billing_dtls join billing  on billing_dtls.bill_id=billing.id 
                  ...
                  //  print "select sum(total) as total from billing where  counter='$counter' and (mode!='6' and  mode!='1') $cond";
                    ...
                    $query6=  $this->db->query("select sum(billing_dtls.amount) as total, sum(billing_dtls.postal_amt) as postal_amt from billing_dtls join billing  on billing_dtls.bill_id=billing.id 
