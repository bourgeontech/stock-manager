...
/*     overflow: hidden; */
    ...
    #printer{
         ...
         height:385.17181102px;
/*          border: 1px solid black; */
/*         background-color:green; */
    }
    .fixed-header{
        height:77.031496063px;
...
/*        background-color:yellow; */
    ...
    .item-row{
       display: ;
       max-height:18.897637795px;
    }
    .name{
       display: table-cell;
       width:181.41732283px;
       text-align:left;
    }
    .star{
       display: table-cell;
       width:102.04724409px;
       text-align:left;
    }
    .pooja{
       display: table-cell;
