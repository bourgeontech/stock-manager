       ...
       <div class="row">
	     <div class="col-lg-12 col-md-12 col-sm-12 ">		 
	        <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
               ...
               <?php echo form_open_multipart("cms/updateFestivalCommittee/$id"); ?>
      ...
      <div class="col-lg-6">
        ...
        <div class="form-group">
          <div class="row_form">
            ...
            <?PHP if($image!=''){ ?>
				<img src="<?php echo base_url(); ?>/uploads/festivalCommittee/<?PHP echo $image; ?>" style="max-height:60px; width:auto; position: relative; bottom:15px; right:110px;"/> <br><br><br><?PHP } ?>
