       ...
       <div class="row">
	     <div class="col-lg-12 col-md-12 col-sm-12 ">		 
	        <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
		       ...
		       <form action="<?php echo base_url(); ?>index.php/admin/admin/marriage_registration_add" method="post" >
           <div class="col-lg-12 col-md-12 col-sm-12 ">		 
	        <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
               <div class="row">
			    <?php
               ...
               <div class="col-lg-3">
        			<div class="form-group">
        			  <div class="row_form">
           				 ...
           				 <input class="sq_form" placeholder=" Enter Receipt Number" id="receipt_no" name="receipt_no"  type="text" >
						 <?php echo form_error('receiptno', '<div class="error">', '</div>'); ?>
          			</div>
        		</div>
      		</div>
	  <?php } ?>
        ...
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder=" Mdate" id="mdate" name="mdate"  type="date" >
      ...
      <div class="col-lg-3">
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder=" From muhoortham" id="f_muhoortham" name="f_muhoortham"  type="text" >
      ...
      <div class="col-lg-3">
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder=" To muhoortham" id="to_muhoortham" name="to_muhoortham"  type="text" >
      ...
      <div class="form_body">
        ...
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder=" Name" id="groom_name" name="groom_name"  type="text" >
      ...
      <div class="col-lg-4">
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder=" DOB" id="groom_DOB" name="groom_DOB"  type="date" >
      ...
      <div class="col-lg-4">
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder=" Age" id="groom_age" name="groom_age"  type="text" >
      ...
      <div class="col-lg-4">
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder=" Father's Name" id="groom_fname" name="groom_fname"  type="text" >
      ...
      <div class="col-lg-4">
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder=" Mother's Name" id="groom_mname" name="groom_mname"  type="text" >
      ...
      <div class="col-lg-4">
        <div class="form-group">
          <div class="row_form">
            ...
            <textarea class="sq_form" placeholder="address" id="groom_address" name="groom_address"  type="text" ></textarea>
      ...
      <div class="col-lg-4">
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder=" Phone1" id="groom_phone1" name="groom_phone1"  type="text" >
      ...
      <div class="col-lg-4">
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder=" Phone2" id="groom_phone2" name="groom_phone2"  type="text" >
      ...
      <div class="col-lg-4">
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder=" id_proof" id="groom_id_proof" name="groom_id_proof"  type="text" >
      ...
      <div class="col-lg-4">
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder=" ID Proof Number" id="groom_id_proof_no" name="groom_id_proof_no"  type="text" >
      ...
      <div class="form_body">
        ...
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder=" Name" id="bride_name" name="bride_name"  type="text" >
      ...
      <div class="col-lg-4">
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder=" DOB" id="bride_DOB" name="bride_DOB"  type="date" >
      ...
      <div class="col-lg-4">
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder=" Age" id="bride_age" name="bride_age"  type="text" >
      ...
      <div class="col-lg-4">
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder=" Father's Name" id="bride_fname" name="bride_fname"  type="text" >
      ...
      <div class="col-lg-4">
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder=" Mother's Name" id="bride_mname" name="bride_mname"  type="text" >
      ...
      <div class="col-lg-4">
        <div class="form-group">
          <div class="row_form">
            ...
            <textarea class="sq_form" placeholder="address" id="bride_address" name="bride_address"  type="text" ></textarea>
      ...
      <div class="col-lg-4">
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder=" Phone1" id="bride_phone1" name="bride_phone1"  type="text" >
      ...
      <div class="col-lg-4">
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder="Phone2" id="bride_phone2" name="bride_phone2"  type="text" >
      ...
      <div class="col-lg-4">
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder="id_proof" id="bride_id_proof" name="bride_id_proof"  type="text" >
      ...
      <div class="col-lg-4">
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder="ID Proof Number" id="bride_id_proof_no" name="bride_id_proof_no"  type="text" >
      ...
      <div class="col-lg-6">
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder=" Witness 1" id="witness1" name="witness1"  type="text" >
      ...
      <div class="col-lg-6">
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder=" Witness 2" id="witness2" name="witness2"  type="text" >
...
$( document ).ready(function() {
    $('#receiptno').keypress(function(event){
      ...
      if(keycode == '13'){
         ...
         var pooja_url = "<?php echo base_url(); ?>index.php/admin/admin/receiptsearch";
         $.ajax({
             type: 'GET',
             url: pooja_url,
             data: {
