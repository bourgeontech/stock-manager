		  ...
		  <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
			<div class="row">
             ...
             <div class="col-lg-6 col-md-6 col-sm-6 ">
              ...
              <div class="col-lg-12 col-md-12 col-sm-12">
                  <form  action="<?php echo base_url();?>index.php/admin/admin/bill_summary_bytime" method="post">
                    <div class="input-group">
            		  ...
            		  <?php echo form_error('diety', '<div class="error">', '</div>'); ?>
                       <select id="time" name="time" class="form-control" autofocus="autofocus" style="margin:10px 0;height:auto;">
                          <option value="">Select Time</option>
                          <option value="A" <?php if(isset($time)&&$time=="A"){echo "Selected";}?>>All</option>
                          <option value="M" <?php if(isset($time)&&$time=="M"){echo "Selected";}?>>Morning</option>
                          <option value="N" <?php if(isset($time)&&$time=="N"){echo "Selected";}?>>Noon</option>
                          <option value="E" <?php if(isset($time)&&$time=="E"){echo "Selected";}?>>Evening</option>
                      </select>
				...
				<table class="table table-bordered table-hover text-nowrap" width="100%">
				  <thead>
				  	<tr id="header12" style="display:none;">
    					...
    					<strong style="margin-bottom: 5px;color: #ea6227;">Daily Pooja Wise Summary</h4>
    					</td>
    				</tr>
					<tr>
