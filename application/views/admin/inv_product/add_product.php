    ...
    <div class="row">
	     <div class="col-lg-4 col-md-4 col-sm-4 ">		 
	        <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
		       ...
		       <form action="<?php echo base_url(); ?>index.php/admin/admin/inv_product" method="post" >
      ...
      <div class="col-lg-12">
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder=" Name" id="name" name="name"  type="text" required>
      ...
      <div class="col-lg-12">
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder=" In Malayalam" id="name_mal" name="name_mal"  type="text" >
      ...
      <div class="col-lg-12">
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder=" Price" id="price" name="price"  type="text" required>
