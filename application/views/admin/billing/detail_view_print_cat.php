    ...
    @media print {
        ...
        tfoot.print-only {
            ...
            <?php 
                        ...
                        $postal_amt_tot = 0;
                        $cashtot1=0;
                        $qrtot1=0;$cardtot1=0;$nefttot1=0;$motot1=0;          
                    ...
                    <?php foreach ($pooja_data as $key => $pooja): ?>
                      <?php
                        ...
                        <tr>
							...
							<td style="text-align:right"><?php if(@$pooja['cash'] > 0 ){$cashtot+= $pooja['cash'];$cashtot1+= $pooja['cash'];echo $pooja['cash'] ?? 0;}?></td>
                     <td style="text-align:right"><?php if(@$pooja['qrcode'] > 0 ){$qrtot+=$pooja['qrcode'];$qrtot1+=$pooja['qrcode'];echo $pooja['qrcode'] ?? 0;}?></td>
                     <td style="text-align:right"><?php if(@$pooja['neft'] > 0 ){$nefttot+=$pooja['neft'];$nefttot1+=$pooja['neft'];echo $pooja['neft'] ?? 0;}?></td>
                     <td style="text-align:right"><?php if(@$pooja['card'] > 0 ){$cardtot+=$pooja['card'];$cardtot1+=$pooja['card'];echo $pooja['card'] ?? 0;}?></td>
                ...
                <?php endforeach; ?>
                         <tr >
                        	...
                        	<td> </td>
                        	<td> </td>
							<td style="text-align:right"><h4 class="text-blue"> <br><?= number_format((float)$cashtot1, 2, '.', '');?> </h4></td>
                         	<td style="text-align:right"><h4 class="text-blue"> <br><?= number_format((float)$qrtot1, 2, '.', '');?> </h4></td>
                         	<td style="text-align:right"><h4 class="text-blue"> <br><?= number_format((float)$nefttot1, 2, '.', '');?> </h4></td>
                         	<td style="text-align:right"><h4 class="text-blue"> <br><?= number_format((float)$cardtot1, 2, '.', '');?> </h4></td>
