    ...
    <div class="page-header">
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 ">
          <ul class="btn_ul" style="float:right;">
            <li> <a href="<?php echo base_url();?>index.php/admin/admin/view_asset" class="btn btn-primary"><i class="fa fa-eye" aria-hidden="true"></i>&nbsp;&nbsp; View</a> </li>
          </ul>
        </div>
    </div>
    <div class="row">
	     <div class="col-lg-12 col-md-12 col-sm-12">		 
	        <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
               <div class="row">
                  <div class="col-lg-12 col-md-12 col-sm-12 ">
                    <h2 class="page_txt"><i class="fa fa-plus-square-o" aria-hidden="true"></i>&nbsp;&nbsp;Add New Asset </h2>
                  </div>
			   </div>
		       <form action="<?php echo base_url(); ?>index.php/admin/admin/add_asset" method="post" enctype="multipart/form-data">
      ...
      <div class="col-lg-4">
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder=" DOCNO" id="docno" name="docno"  type="text" >
      ...
      <div class="col-lg-4">
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder=" asset Publisher" id="itemcode" name="itemcode"  type="text" >
      ...
      <div class="col-lg-4">
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder=" Itemname" id="itemname" name="itemname"  type="text" >
      ...
      <div class="col-lg-4">
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder=" Purchase from / Received from" id="p_from" name="p_from"  type="text" >
      ...
      <div class="col-lg-4">
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder="Bill no" id="bill_no" name="bill_no"  type="text" >
      ...
      <div class="col-lg-4">
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder=" Bill Date" id="bill_date" name="bill_date" value="<?php date('Y-m-d');?>" type="date" >
      ...
      <div class="col-lg-4">
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder=" Gurrantee Period" id="period" name="period"  type="text" >
      ...
      <div class="col-lg-4">
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder="Guarantee details" id="details" name="details"  type="text" >
      ...
      <div class="col-lg-4">
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder="Quantity" id="qlt" name="qlt"  type="text" >
      ...
      <div class="col-lg-4">
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder="Unit" id="unit" name="unit"  type="text" >
      ...
      <div class="col-lg-4">
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder="Weight" id="weight" name="weight"  type="text" >
      ...
      <div class="col-lg-4">
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder="Price" id="price" name="price"  type="text" >
      ...
      <div class="col-lg-4">
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder="Remark" id="remark" name="remark"  type="text" >
...
<script>
	function change_category(){
		var cat_id=$('#ass_cat').val();
        $('#sub_category').html("");
        var html='<option value="">Select Sub Category</option>';
        var url = '<?php echo base_url();?>index.php/admin/admin/getasssubcat';
    	$.ajax({
            type: "POST",
            url: url,
            data: {'cat_id': cat_id},
