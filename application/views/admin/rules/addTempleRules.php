    ...
    <div class="page-header">
       ...
       <div class="row">
	     <div class="col-lg-12 col-md-12 col-sm-12 ">		 
	        <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
               <div class="row">
                  <div class="col-lg-12 col-md-12 col-sm-12 ">
                    <h2 class="page_txt"><i class="fa fa-plus-square-o" aria-hidden="true"></i>&nbsp;&nbsp;Add Temple Rules </h2>
                  </div>
			   </div>
               <?php echo form_open_multipart("cms/addTempleRules"); ?>
      ...
      <div class="col-lg-12">
        <div class="form-group">
            ...
            <textarea class="" id="rules" name="rules" rows="6" style="width: 100%;"><span></span></textarea>
