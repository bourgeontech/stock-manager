...
<head>
    ...
    <style>
        ...
        body{
            background-image: <?php echo $letterhead;?>;
	...
	<div class="fluid-container w-95 mx-auto">
        ...
        <div class="bill-date mt-3">
           <div>
            ...
            <div >
                <p class="bill"> <?php print_r($pooja->name); ?> </p>
            </div>
            <div >
        ...
        <table class="w-100">
        	...
        	<tfoot>
            	<th <?php
				if($_SERVER['HTTP_HOST'] == "kaladyshankaramadomts.org") { ?> colspan="8" <?php } else { ?>colspan="8" <?php } ?> class="text-center">SUB TOTAL</th>
        ...
        <section id="noteSection" class="mt-auto <?php if($pageBreak1 == 1) echo "page-break-before"; ?>" style="margin-top: 320px;
                page-break-before: always;
                padding-top: 320px;">
            <div class="last">
                <p class="note">Note:-</p>
...
<script>
window.onfocus = function () { setTimeout(function () { window.location = "<?php echo base_url();?>index.php/worldline/booking" }, 500); }
function myFunction(){
    window.location = "<?php echo base_url();?>index.php/worldline/booking";
}
