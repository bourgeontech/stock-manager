      ...
      // print "SELECT * FROM user_dtl WHERE name='$costname' AND mobile='$mobile' AND status='1'";exit;
        ...
        if($cost==0){
            ...
            while ($i<sizeof($name)){
                ...
                $this->db->query("INSERT INTO donation(`bill_id`,`customer_id`,`name`,`diety_id`,`star`,`pooja`,`qlt`,`unit`,`amount`,`remark`,`annotation`,`user_id`,`date`,`created`,`status`) VALUES ('$last_id','$user_id','$nama','$diety_id','$ster','$poja','$qult','$unet','$amot','$rmrk','$annotation',
                '$logged','$data','$date', '1')");
