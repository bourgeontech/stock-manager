        ...
        <div class="col-lg-12 col-md-12 col-sm-12 ">
        	<div class="card">
            	<div class="card-header pt-5">
                	<h4> Add Ledger Modes </h4>
        		</div>
            	<div class="card-body p-5">
                	<form method="POST" action="<?php echo base_url(); ?>index.php/accounts/mapLedgerModes">
                	<table class="table border">
                    	<thead>
                        	<tr>
                            	<th>Payment Mode</th>
                            	<th>Parent Ledger (Pooja Category Ledger)</th>
                            	<th>Ledger (Cash / Bank Ledger)</th>
                        	</tr>
                    	</thead>
    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 ">
            <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-6 ">
                        <h2 class="page_txt"><i class="fa fa-list" aria-hidden="true"></i>&nbsp;&nbsp; Ledger Modes </h2>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6 ">
                        <div class="header">
                ...
                <table class="table border">
                    ...
                    <tbody>
                        <?php foreach($ledger_modes as $key => $ledger_mode): ?>
                        <tr>
                            <td> <?php echo $key + 1; ?> </td>
                            <td> <?php echo $ledger_mode->mode; ?> </td>
                        	<td> <?php echo $ledger_mode->parent_ledger; ?> </td>
                        	<td> <?php echo $ledger_mode->ledger; ?> </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
                </table>
