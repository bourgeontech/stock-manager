  ...
  <div class="side_right">
    ...
    <div class="page-header">
        <div class="col-lg-6 col-md-6 col-sm-6 ">
          <h4 class="page_txt"><?php echo $this->lang->line('treasure') ?? 'Bandaram'; ?> Master</h4>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6 ">
	        ...
	        <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
               <div class="row">
                  <div class="col-lg-12 col-md-12 col-sm-12 ">
                    <h2 class="page_txt"><i class="fa fa-plus-square-o" aria-hidden="true"></i>&nbsp;&nbsp;Add New <?php echo $this->lang->line('treasure') ?? 'Bandaram'; ?> </h2>
                  </div>
			   </div>
		       <form action="<?php echo base_url(); ?>index.php/admin/admin/bandaram" method="post" >
      ...
      <div class="form_body">
        ...
        <div class="form-group">
		  ...
		  <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
			<div class="row">
              <div class="col-lg-12 col-md-12 col-sm-12 ">
                <h2 class="page_txt"><i class="fa fa-list-ol" aria-hidden="true"></i>&nbsp;&nbsp;List of <?php echo $this->lang->line('treasure') ?? 'Bandaram'; ?> </h2>
              </div>
			 </div>		
