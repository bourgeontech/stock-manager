    ...
    <div class="row">
	     <div class="col-lg-4 col-md-4 col-sm-4 ">		 
	        <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
		       ...
		       <form action="<?php echo base_url(); ?>index.php/admin/admin/supplier" method="post" >
      ...
      <div class="col-lg-12">
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder=" Address" id="address" name="address"  type="text" >
      ...
      <div class="col-lg-12">
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder=" Contact No" id="contact_no" name="contact_no"  type="text" >
      ...
      <div class="col-lg-12">
        <div class="form-group">
          <div class="row_form">
            ...
            <input class="sq_form" placeholder=" Contact Person" id="contact_person" name="contact_person"  type="text" >
