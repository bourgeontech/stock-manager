		   ...
		   <div class="col-lg-12">
              <div class="form-group">
                  <div class="row_form">
            		...
            		<tbody id="dataTable2">
                		<tr>
                        	...
                        	<td><select name="pooja[]" id="pooja_100" onchange="change_rate(100)" onload="change_rate(100)" class="sq_form js-example-basic-single pooja_id" required style="width: 5cm;">
                                	<option value="">Select Pooja</option>
                    			</select>
                			</td>
                			<td><input type="text" name="name[]" id="name_100" class="sq_form name" placeholder="Name" value="*" required style="width: 2.8cm;"></td>
                			<td>
                            	<select name="star[]" id="star_100" class=" sq_form js-example-basic-single" required style="width: 2.8cm;">
               ...
               <input type="text" name="search_pooja" class="sq_form" id="searchpooja" placeholder="Type in pooja code and press enter to search" autofocus="autofocus"  />
                        	...
                        	<td><input type="text" name="gothram[]" id="gothram_100" class="sq_form gothram" placeholder="Gothram" value=""></td>
            ...
            <div class="form-group" style="margin-top: 7px;" id="paymenttable">
                   <select id="mode" name="mode" class="sq_form" required onchange="openpaydetails()" >
                       <?php foreach($payment_modes as $modes){?>
                   			<option value="<?php echo $modes['id']?>"><?php echo $modes['name']?></option>
                   		<?php }?>
...
var availabilityChecked = false;
  ...
  // alert("o");
    ...
    function addRow() {
		...
		var gothram=$('#gothram_'+row_value).val();
        ...
        var html = '<tr>';
			...
			<?php } ?>
            html +='</select></td>';
    		html +='<td><select name="pooja[]" id="pooja_'+row_value+'" onchange="change_rate('+row_value+')" class="js-example-basic-single sq_form pooja_id" required style="width: 5cm;"><option value="">Select Pooja</option>';
            html +='</select></td>';
            html +='<td><input type="text" name="name[]" id="name_'+row_value+'" class="sq_form name" placeholder="Name" value="*" required style="width: 2.8cm;"></td>';
            html +='<td><select name="star[]" id="star_'+row_value+'" class="js-example-basic-single sq_form" required style="width: 2.8cm;"><option value="28">nodata</option>';
			<?php foreach($birth_star as $val){ ?>
			html +='<option value="<?= $val['id']; ?>"><?php if($site[0]['starcode']=="1"){echo $val['id']." - ";} echo $val['name_eng']." - ".$val['name_mal']." (". $val['id'].")" ?></option>';
			<?php } ?>
            html +='</select></td>';
            html += '<td><input type="text" name="gothram[]" id="gothram_'+row_value+'" class="sq_form gothram" placeholder="Gothram" value=""></td>';
			...
			$('#gothram_'+row_value).val(gothram);
...
function setDevotee(data){
 	$("#search_devotee").val(data.mobile)
 ...
 $('#star_100').val(data.star_id).trigger('change');
	        ...
	        Swal.fire({
              ...
              <form id="myForm">
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            <input type="text" name="house" placeholder="House No" class="form-control custom-input">
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="form-group">
                    ...
                    <div class="col-md-4">
					 ...
					 <div class="col-md-4">
                        <div class="form-group">
                            <input type="text" name="gothram" placeholder="Gothram" class="form-control custom-input" >
                        </div>
                    </div>
					 <div class="col-md-4">
                        <div class="form-group">
                ...
                if (form.checkValidity()) {
                    ...
                    $.ajax({
                        ...
                        data: {
							...
							'gothram'   : formData.get('gothram'),
							'star_id'   : formData.get('star_id'),
                        },
                        success: function (data) {
                            if (data) {
