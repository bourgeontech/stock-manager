    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-sm-12 ">         
            <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 ">
                        <h2 class="page_txt"><i class="fa fa-plus-square-o" aria-hidden="true"></i>&nbsp;&nbsp;Add Image Category </h2>
                    </div>
                </div>
            
                <form action="<?php echo base_url();?>index.php/cms/addImageCategory" method="post">
                    <div class="form_body">
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="form-group">
                                    ...
                                    <input class="sq_form" placeholder="Category" name="category" type="text">
