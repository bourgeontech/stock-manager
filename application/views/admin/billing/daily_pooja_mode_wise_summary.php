		  ...
		  <div class="shadow-sm p-3 mb-2 bg-white" style="position:relative" >
			<div class="row">
             ...
             <div class="col-lg-6 col-md-6 col-sm-6 ">
              ...
              <div class="col-lg-6 col-md-6 col-sm-6 ">
                  <ul class="btn_ul" style="float:right;">
                    <li> <a href="<?php echo base_url();?>index.php/admin/admin/daily_pooja_mode_wise_summary" class="btn btn-primary">Detailed Summary</a> </li>
                  </ul>
              </div> 
              <div class="col-lg-12 col-md-12 col-sm-12">
                  <form  action="<?php echo base_url();?>index.php/admin/admin/daily_pooja_mode_wise_summary" method="post">
				...
				<table class="table table-bordered table-hover text-nowrap" width="100%">
				  <thead>
					...
					<tr>
                      ...
                      <th scope="col" style="text-align:right">Bank</th>
				  ...
				  <tbody>
					<tr>
                     ...
                     <td style="text-align:right"><?= number_format((float)$other, 2, '.', '');?></td>
                     <td style="text-align:right; font-weight:bold"><?= number_format((float)$amt, 2, '.', '');?></td>
					</tr>
				  </tbody>
					<?php } }
                     else {
					...
					<tfoot>
                    	...
                    	<th style="text-align:right"><h5><?= number_format((float)$cash_tot, 2, '.', '');?></h5></th>
                    	<th style="text-align:right"><h5><?= number_format((float)$other_tot, 2, '.', '');?></h5></th>
                    	<th style="text-align:right"><h4><?= number_format((float)$tot, 2, '.', '');?></h4></th>
					</tfoot>
				</table>
             </div>
             <?php }?>
